...
export function LocationImportDialog({ isOpen, onClose, onImport, loading }: LocationImportDialogProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                <div className="mb-4 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-50">Import Locations</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="mb-6 space-y-4">
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">
                        Upload a previously exported JSON file containing locations. New IDs will be generated to avoid conflicts.
                    </p>
