...
export function CampaignActivityFeed({ campaignId }: CampaignActivityFeedProps) {
    ...
    const getIcon = (type: CampaignActivityType) => {
        switch (type) {
            case "player_joined": return <UserPlus className="w-4 h-4 text-green-500" />;
            case "player_left": return <UserMinus className="w-4 h-4 text-red-500" />;
            case "character_created": return <FileText className="w-4 h-4 text-blue-500" />;
            case "character_approved": return <CheckCircle className="w-4 h-4 text-green-600" />;
            case "character_rejected": return <XCircle className="w-4 h-4 text-red-600" />;
            case "session_scheduled": return <Calendar className="w-4 h-4 text-purple-500" />;
            ...
            case "post_created": return <MessageSquare className="w-4 h-4 text-indigo-500" />;
            case "campaign_updated": return <Settings className="w-4 h-4 text-gray-500" />;
            case "location_added": return <MapPin className="w-4 h-4 text-orange-500" />;
