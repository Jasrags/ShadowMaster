...
export default function CampaignPostsTab({ campaign, userRole }: CampaignPostsTabProps) {
    ...
    const getBgColor = (type: string) => {
        switch (type) {
            ...
            case "rumor": return "bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800";
            default: return "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800";
        }
    };
                    ...
                    <form onSubmit={handleCreatePost} className="space-y-4">
                        ...
                        {userRole === "gm" && (
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <label htmlFor="isPinned" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                    Pin this post
                                </label>
                            </div>
                        )}
