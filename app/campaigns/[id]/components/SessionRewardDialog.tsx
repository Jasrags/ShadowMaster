                    ...
                    <div className="flex items-center gap-2 rounded-lg bg-indigo-50 p-3 dark:bg-indigo-900/20">
                      ...
                      >
                        {({ isSelected }) => (
                          <>
                            <div
                              className={`flex h-4 w-4 items-center justify-center rounded border ${isSelected ? "bg-indigo-600 border-indigo-600" : "bg-white border-zinc-300 dark:bg-zinc-800 dark:border-zinc-600"}`}
                            >
                    ...
                    <div className="flex-1 overflow-y-auto rounded-lg border border-zinc-200 bg-zinc-50 p-2 dark:border-zinc-800 dark:bg-zinc-900/50">
                      {fetchingCharacters ? (
                        ...
                        <p className="py-8 text-center text-sm text-zinc-500">
                          No characters found in campaign.
                        </p>
                      ) : (
                        <CheckboxGroup
