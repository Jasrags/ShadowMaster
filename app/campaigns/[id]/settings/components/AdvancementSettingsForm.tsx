...
export default function AdvancementSettingsForm({
  settings,
  onChange,
}: AdvancementSettingsFormProps) {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("attributeKarmaMultiplier", parseInt(e.target.value) || 5)
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("skillGroupKarmaMultiplier", parseInt(e.target.value) || 5)
              }
              className="block w-full rounded-md border border-zinc-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-zinc-700 dark:bg-black dark:text-white"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("knowledgeSkillKarmaMultiplier", parseInt(e.target.value) || 1)
              }
              className="block w-full rounded-md border border-zinc-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-zinc-700 dark:bg-black dark:text-white"
            />
          </div>
      ...
      <div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div>
            ...
            <p className="mb-2 text-xs text-zinc-500 dark:text-zinc-400">Default: 7 Karma</p>
            <input
              type="number"
              min="1"
              value={settings.specializationKarmaCost}
              onChange={(e) =>
                handleChange("specializationKarmaCost", parseInt(e.target.value) || 7)
              }
              className="block w-full rounded-md border border-zinc-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-zinc-700 dark:bg-black dark:text-white"
            />
          </div>
          <div>
            ...
            <p className="mb-2 text-xs text-zinc-500 dark:text-zinc-400">Default: 5 Karma</p>
            <input
              type="number"
              min="1"
          ...
          <div>
            ...
            <p className="mb-2 text-xs text-zinc-500 dark:text-zinc-400">Default: 4 Karma</p>
            <input
              type="number"
              min="1"
      ...
      <div>
        ...
        <div className="rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800 dark:text-blue-300">Rating Caps</h3>
              <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                <p>
                  These caps limit how high a rating can be raised through advancement. Metatype
                  maximums (augmented) still apply if lower than these caps.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Training Rules */}
      <div>
        <h3 className="mb-4 text-sm font-medium text-zinc-900 dark:text-zinc-50">Training Rules</h3>
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("trainingTimeMultiplier", parseFloat(e.target.value) || 1)
              }
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              <label
                htmlFor="allowInstantAdvancement"
