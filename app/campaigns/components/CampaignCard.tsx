...
export default function CampaignCard({ campaign, userRole, onView }: CampaignCardProps) {
    return (
        <div
            ...
            className="group cursor-pointer rounded-lg border border-zinc-200 bg-white p-6 transition-all hover:border-zinc-300 hover:shadow-lg dark:border-zinc-800 dark:bg-black dark:hover:border-zinc-700"
        >
