        ...
        <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-black">
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                    ...
                    {/* Edition */}
                    <div>
                        <label htmlFor="edition" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">
                            Edition *
                        </label>
                        <select
                            id="edition"
                                ...
                                {books.map((book) => (
                                    <label key={book.id} className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-zinc-700 dark:text-zinc-300">
                                            {book.title}
                                            {book.isCore && (
                                                <span className="ml-1 text-xs text-indigo-600 dark:text-indigo-400">(Core)</span>
                                            )}
                                        </span>
                                    </label>
                                ))}
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading || !title || !editionCode || enabledBookIds.length === 0 || enabledCreationMethodIds.length === 0}
