...
import {
  ...
  extractLifestyleModifications,
  extractEntertainmentOptions,
  extractNeighborhoodZones,
  extractGear,
  ...
  try {
    ...
    const extractedData = loadedRuleset
      ? {
          ...
          entertainmentOptions: extractEntertainmentOptions(loadedRuleset),
          neighborhoodZones: extractNeighborhoodZones(loadedRuleset),
          ...
          dataSoftware: extractDataSoftwareCatalog(loadedRuleset),
          ...
          johnsonProfiles: extractJohnsonProfiles(loadedRuleset),
