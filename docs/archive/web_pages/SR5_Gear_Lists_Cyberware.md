...
- [1 Lists](#Lists)
  - [1.1 Ware Grades](#Ware_Grades)
  - [1.2 Cyberware](#Cyberware)
  - [1.3 Bioware](#Bioware)
...
| **Basic** | **Chemical Gland** | 0.1 | 12R (or chemical) | 20,000¥ | SR5:CF p.112 |
| **Basic** | **Gradual Release** | +- | - | -¥ | SR5:CF p.112 |
| **Basic** | **Exhalation Spray** | +0.1 | 12R | 6,000¥ | SR5:CF p.112 |
| **Basic** | **Internal Release** | +0 | - | -¥ | SR5:CF p.112 |
| **Basic** | **Spit** | +0.1 | 12R | 6,000¥ | SR5:CF p.112 |
| **Basic** | **Weapon Reservoir** | +0.1 | 12F | 4,000¥ | SR5:CF p.112 |
| **Basic** | **Expanded Reservoir** | +0.1 | 12 | 2,000¥ | SR5:CF p.112 |
...
| **Basic** | **Sharkskin** | 0.25 | 8 | 8,000¥ | SR5:CF |
