...
Players should only have one Priority Level left to assign to Resources. This Priority Level determines the amount of money that characters will have to spend on the gear they’ll use to kick some ass, as well as a place to crash when the heat’s off. See **[Street Gear](/Shadowrun/index.php/SR5:Gear_List "SR5:Gear List")** for available equipment. In this step, you’ll improve your character through spending money; any improvements made with the player’s Karma fund are handled in **[Step Seven: Spending Your Left Over Karma](/Shadowrun/index.php/SR5:Character_Creation:Step_7 "SR5:Character Creation:Step 7")**.
...
- [1 CYBERWARE AND BIOWARE](#CYBERWARE_AND_BIOWARE)

- [2 LIFESTYLE](#LIFESTYLE)

- [3 STARTING NUYEN](#STARTING_NUYEN)
...
There are four grades of available **[cyberware and bioware: standard, alphaware, betaware, and deltaware](/Shadowrun/index.php/SR5:Gear_Lists:Cyberware "SR5:Gear Lists:Cyberware")**. Only standard gear and alphaware are available at character creation.
...
James assigns his final Priority Level, level A, to Resources. This gives James 450,000 nuyen with which to buy gear. Here is
what he picks up:
