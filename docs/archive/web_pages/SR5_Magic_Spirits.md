...
- [1 SUMMONING](#SUMMONING)
  - [1.1 STEP 1: CHOOSE SPIRIT TYPE & FORCE](#STEP_1:_CHOOSE_SPIRIT_TYPE_.26_FORCE)
    - [1.1.1 GROUP SUMMONING](#GROUP_SUMMONING)
  - [1.2 STEP 2: ATTEMPT SUMMONING](#STEP_2:_ATTEMPT_SUMMONING)
  - [1.3 STEP 3: RESIST DRAIN](#STEP_3:_RESIST_DRAIN)
  - [1.4 GLITCHES](#GLITCHES)

- [2 BINDING](#BINDING)

- [3 SPIRITUAL RELATIONSHIPS](#SPIRITUAL_RELATIONSHIPS)

- [4 BAD FEELINGS WITH BOUND SPIRITS](#BAD_FEELINGS_WITH_BOUND_SPIRITS)

- [5 BANISHING](#BANISHING)

- [6 SPIRIT-SUMMONER LINK](#SPIRIT-SUMMONER_LINK)

- [7 SPIRIT RANGE](#SPIRIT_RANGE)

- [8 SPIRIT SERVICES](#SPIRIT_SERVICES)
  - [8.1 UNBOUND SPIRIT SERVICES](#UNBOUND_SPIRIT_SERVICES)
  - [8.2 BOUND SPIRIT SERVICES](#BOUND_SPIRIT_SERVICES)

- [9 SPIRITS AND EDGE](#SPIRITS_AND_EDGE)
...
## BAD FEELINGS WITH BOUND SPIRITS

Spirits are powerful entities, and the ability to call on their potent skills is formidable.
While unbound spirits are limited in the services they can offer, bound spirits are compelled by the magical bond to do their utmost on the magician’s behalf, even if it means sacrificing their Force and disrupting themselves for a time.
