...
- [1 Adrenaline Pump (R 1–3)](#Adrenaline_Pump_.28R_1.E2.80.933.29)

- [2 Bone Density Augmentation (R 1–4)](#Bone_Density_Augmentation_.28R_1.E2.80.934.29)

- [3 Cat’s Eye](#Cat.E2.80.99s_Eye)

- [4 Enhanced Articulation](#Enhanced_Articulation)

- [5 Muscle Augmentation (R 1–4)](#Muscle_Augmentation_.28R_1.E2.80.934.29)

- [6 Muscle Toner (R 1–4)](#Muscle_Toner_.28R_1.E2.80.934.29)

- [7 Orthoskin (R 1–4)](#Orthoskin_.28R_1.E2.80.934.29)

- [8 Pathogenic Defense (R 1–6)](#Pathogenic_Defense_.28R_1.E2.80.936.29)

- [9 Platelet Factories](#Platelet_Factories)

- [10 Skin Pocket](#Skin_Pocket)

- [11 Suprathyroid Gland](#Suprathyroid_Gland)

- [12 Symbiotes (R 1–4)](#Symbiotes_.28R_1.E2.80.934.29)

- [13 Synthacardium (R 1–3)](#Synthacardium_.28R_1.E2.80.933.29)

- [14 Tailored Pheromones (R 1–3)](#Tailored_Pheromones_.28R_1.E2.80.933.29)

- [15 Toxin Extractor (R 1–6)](#Toxin_Extractor_.28R_1.E2.80.936.29)

- [16 Tracheal Filter (R 1–6)](#Tracheal_Filter_.28R_1.E2.80.936.29)

- [17 Amplified Immune System (1-4)](#Amplified_Immune_System_.281-4.29)

- [18 Chemical Gland](#Chemical_Gland)
  - [18.1 Gradual Release](#Gradual_Release)
  - [18.2 Exhalation Spray](#Exhalation_Spray)
  - [18.3 Internal Release](#Internal_Release)
  - [18.4 Spit](#Spit)
  - [18.5 Weapon Reservoir](#Weapon_Reservoir)
  - [18.6 Expanded Reservoir](#Expanded_Reservoir)

- [19 Elastic Joints](#Elastic_Joints)

- [20 Expanded Volume (1-4)](#Expanded_Volume_.281-4.29)

- [21 Gills](#Gills)

- [22 Hand And Foot Webbing](#Hand_And_Foot_Webbing)

- [23 Hearing Enhancement](#Hearing_Enhancement)

- [24 Hearing Expansion](#Hearing_Expansion)

- [25 Joint Replacement](#Joint_Replacement)

- [26 Nephritic Screen (1-6)](#Nephritic_Screen_.281-6.29)

- [27 Nictitating Membrane](#Nictitating_Membrane)

- [28 Replacement Limbs](#Replacement_Limbs)
  - [28.1 Replacement Finger/Toe](#Replacement_Finger.2FToe)
  - [28.2 Replacement Hand/Foot](#Replacement_Hand.2FFoot)
  - [28.3 Replacement Partial Arm/Leg](#Replacement_Partial_Arm.2FLeg)
  - [28.4 Replacement Full Arm/Leg](#Replacement_Full_Arm.2FLeg)

- [29 Spidersilk Gland](#Spidersilk_Gland)

- [30 Spinal Re-alignment](#Spinal_Re-alignment)

- [31 Tactile Sensitivity](#Tactile_Sensitivity)

- [32 Tail](#Tail)

- [33 Tail (prehensile)](#Tail_.28prehensile.29)

- [34 Tailored Critter Pheromones (1-3)](#Tailored_Critter_Pheromones_.281-3.29)

- [35 Troll Eyes](#Troll_Eyes)

- [36 Vocal Range Enhancer](#Vocal_Range_Enhancer)

- [37 Vocal Range Expander](#Vocal_Range_Expander)

- [38 Orthoskin Upgrades](#Orthoskin_Upgrades)
  - [38.1 Chemical Repulsion](#Chemical_Repulsion)
  - [38.2 Dragon Hide](#Dragon_Hide)
  - [38.3 Electroshock](#Electroshock)
  - [38.4 Insulation](#Insulation)
  - [38.5 Penguin Blubber](#Penguin_Blubber)
  - [38.6 Sealskin](#Sealskin)
  - [38.7 Sharkskin](#Sharkskin)
...
| ------------- | -------- | ------------- | ---------------- | ------ |
| Rating x 0.75 | -        | (Rating x 6)F | 55,000¥ x Rating | Core   |

| Trigger Pump Free Action Active Benefits Ignore Injury Modifiers Can't Fall Unconscious +Rating to STR, AGI, REA, WIL Active Duration Rating x 1D6 Combat Turns After Duration Duration amount of Stun Damage (Resist with Body + Willpower) Recharge Rate 1 Hour | |
...
| ESSENCE      | CAPACITY | AVAIL      | COST            | SOURCE |
| ------------ | -------- | ---------- | --------------- | ------ |
| Rating x 0.3 | -        | Rating x 4 | 5,000¥ x Rating | Core   |
...
| ESSENCE | CAPACITY | AVAIL | COST             | SOURCE |
| ------- | -------- | ----- | ---------------- | ------ |
| 0.3     | -        | 12    | 24,000¥ x Rating | Core   |

| Escape Artist +1 DP Physical Limit +1 | |
...
| ESSENCE      | CAPACITY | AVAIL         | COST             | SOURCE |
| ------------ | -------- | ------------- | ---------------- | ------ |
| Rating x 0.2 | -        | (Rating x 5)R | 31,000¥ x Rating | Core   |

| Add Rating to Strength | |
...
| ESSENCE      | CAPACITY | AVAIL         | COST             | SOURCE |
| ------------ | -------- | ------------- | ---------------- | ------ |
| Rating x 0.2 | -        | (Rating x 5)R | 32,000¥ x Rating | Core   |

| Add Rating to Agility | |
...
| ESSENCE       | CAPACITY | AVAIL         | COST            | SOURCE |
| ------------- | -------- | ------------- | --------------- | ------ |
| Rating x 0.25 | -        | (Rating x 4)R | 6,000¥ x Rating | Core   |
...
| ESSENCE      | CAPACITY | AVAIL      | COST            | SOURCE |
| ------------ | -------- | ---------- | --------------- | ------ |
| Rating x 0.1 | -        | Rating x 2 | 4,500¥ x Rating | Core   |

| Add Rating to Disease Resistance | |
...
| ESSENCE | CAPACITY | AVAIL | COST             | SOURCE |
| ------- | -------- | ----- | ---------------- | ------ |
| 0.2     | -        | 12    | 17,000¥ x Rating | Core   |

| Reduce 2 or more Physical Damage by 1 | |
...
| ESSENCE | CAPACITY | AVAIL | COST             | SOURCE |
| ------- | -------- | ----- | ---------------- | ------ |
| 0.1     | -        | 4     | 12,000¥ x Rating | Core   |

| Add/Remove Object Complex Action Concealability -10 Size Small | |
| This skin flap can be located anywhere on your body. A nerveless “sheath” of flesh concealed by the flap is perfect for hiding a small object—it’s the bioware version of a **smuggling compartment** . The skin pocket has a Concealability of –10. It takes a Complex Action to add or remove an item from a skin pocket. |
...
| ESSENCE | CAPACITY | AVAIL | COST              | SOURCE |
| ------- | -------- | ----- | ----------------- | ------ |
| 0.7     | -        | 20R   | 140,000¥ x Rating | Core   |

| Pros +1 to AGI, BOD, REA, STR Cons LifeStyle Cost + 25% | |
...
| ESSENCE      | CAPACITY | AVAIL      | COST            | SOURCE |
| ------------ | -------- | ---------- | --------------- | ------ |
| Rating x 0.2 | -        | Rating x 5 | 3,500¥ x Rating | Core   |

| Pros +Rating DP to Healing Tests Cons -Rating x 200 Nuyen per Month (Unless High Lifestyle or Better) | |
...
| ESSENCE      | CAPACITY | AVAIL      | COST             | SOURCE |
| ------------ | -------- | ---------- | ---------------- | ------ |
| Rating x 0.1 | -        | Rating x 4 | 30,000¥ x Rating | Core   |

| +Rating DP to Athletics Skill Tests | |
| Artificially hanced myocardium allows cardiovascular functions to be performed more efficiently, enabling the heart to keep the blood better oxygenated. The synthacardium adds its Rating as a dice pool bonus to your tests using skills in the Athletics skill group. |
...
| ESSENCE      | CAPACITY | AVAIL         | COST             | SOURCE |
| ------------ | -------- | ------------- | ---------------- | ------ |
| Rating x 0.2 | -        | (Rating x 4)R | 31,000¥ x Rating | Core   |

| +Rating DP to Acting and Influence Skill Tests +Rating to Social Limit | |
...
| ESSENCE      | CAPACITY | AVAIL      | COST            | SOURCE |
| ------------ | -------- | ---------- | --------------- | ------ |
| Rating x 0.2 | -        | Rating x 3 | 4,800¥ x Rating | Core   |

| +Rating DP to Toxin Resistance Tests | |
| A specially cultivated cluster of cells in your liver improves its filtering capabilities. The toxin extractor adds its Rating as a dice pool modifier to all your Toxin Resistance Tests (Toxins, Drugs, and BTLs, p. 408). |
...
| ESSENCE      | CAPACITY | AVAIL      | COST            | SOURCE |
| ------------ | -------- | ---------- | --------------- | ------ |
| Rating x 0.1 | -        | Rating x 3 | 4,500¥ x Rating | Core   |

| +Rating DP to Inhalation Toxin Resistance | |
| Implanted at the top of your trachea, this organ can absorb airborne impurities and keep them from reaching your lungs. The filter adds its Rating as a dice pool modifier to Toxin Resistance Tests versus inhalation vector toxins (Toxins, Drugs, and BTLs, p. 408). |
...
| ESSENCE        | CAPACITY | AVAIL        | COST              | SOURCE |
| -------------- | -------- | ------------ | ----------------- | ------ |
| (Rating) x 0.1 | -        | (Rating) x 7 | (Rating) x 4,000¥ | SR5:CF |
...
| ESSENCE | CAPACITY | AVAIL             | COST                      | SOURCE |
| ------- | -------- | ----------------- | ------------------------- | ------ |
| 0.1     | -        | 12R (or chemical) | 20,000¥ + (100X Chemical) | SR5:CF |
...
| Benefits User under the effect of the chemical at all times | |
| A chemical gland can be used to leak its substance continuously into the body, ensuring that a dose is present at all times. This leaves the user under the effect of the chemical at all times and eliminates any reserve. This can easily lead to terminal addiction for certain chemicals. |
...
| Benefits Inject chemical with an action | |
| The most common method is a simple internal release, triggered by mental command not terribly different from flexing a muscle. In this way, it serves as a sort of biological auto-injector. This is the default method of release and is included in the cost of the gland. |
...
| ESSENCE | CAPACITY | AVAIL | COST   | SOURCE |
| ------- | -------- | ----- | ------ | ------ |
| 0.1     | -        | 12F   | 4,000¥ | SR5:CF |

| Benefit Coat bioware/cyberware weapon in a chemical | |
...
| ESSENCE | CAPACITY | AVAIL | COST                            | SOURCE |
| ------- | -------- | ----- | ------------------------------- | ------ |
| 0.1     | -        | 12    | 2,000¥ + (cost of compound x 4) | SR5:CF |

| Benefits Chemical gland gains four extra doses (up to a maximum of 20 doses per gland) | |
| A chemical gland may have up to four additional reservoirs attached to it, each holding up to four more doses of the chemical in question. While a character may have multiple chemical glands, they may not share reservoirs. |
...
| ESSENCE        | CAPACITY | AVAIL        | COST              | SOURCE |
| -------------- | -------- | ------------ | ----------------- | ------ |
| (Rating) x 0.1 | -        | (Rating) x 4 | (Rating) x 2,000¥ | SR5:CF |
...
## Nephritic Screen (1-6)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| ESSENCE         | CAPACITY | AVAIL        | COST              | SOURCE |
| --------------- | -------- | ------------ | ----------------- | ------ |
| (Rating) x 0.05 | -        | (Rating) x 2 | (Rating) x 4,000¥ | SR5:CF |
...
## Tailored Critter Pheromones (1-3)
...
| ESSENCE | CAPACITY | AVAIL | COST    | SOURCE |
| ------- | -------- | ----- | ------- | ------ |
| 0.25    | -        | 12R   | 20,000¥ | SR5:CF |

| Benefits Immunity to substances +2 against Contact Penalties -2 Body on Fatigue tests Hot environments increase in everity by one step | |
| By sealing the skin tightly, the user trades natural cooling via sweating for a sealed system, allowing them to resist chemical attacks more easily, including complete immunity to . Not recommended for athletes or others who regularly indulge in endurance-based activities, as the lack of a cooling system other than panting is quite dangerous for metahumans! Drink fluid often. In addition to immunity to any DMSO-carried substance, the user gains +2 Body to resist any contact-vector toxin. The user also suffers a penalty of –2 Body for any Fatigue test and suffers an increase in severity by one step from any hot environment. (p. 172, SR5); for example, a Moderate situation for others is Harsh for the user. |
...
| Benefits +2 Bidy against Damage Penalties -2 to Perception tests for heat detection | |
| While many expect this mod to involve scales, that would be a simple cosmetic modification unconnected to the actual upgrade. Dragon Hide weaves flame-retardant materials into the orthoskin, which distributes thermal impact, prevents blistering, and reduces overall burning as energy dissipates across the larger surface. The user gains +2 Body for resisting Fire damage, but also has a –2 penalty on Perception Tests involving heat detection. |
...
| Benefits +2 Body for resisting damage Penalty:Not compatible with electroshock | |
| Use of non-conductive materials leaves the user more resistant against electrical discharges, keeping the vulnerable organs inside safer than before. The user gains +2 Body for resisting electrical damage. This is not compatible with electroshock. |
...
| Benefits +2 Body for resisting Damage x5 time interval for harsh cold for Fatigue damage | |
...
| Benefit:No penalties for moving in water | |
| This simple skin is coated with naturally refreshing water-repelling oils that allow the user to cut through the waves with ease. The user’s skin retains a somewhat moist appearance at all times. Sealskin removes all penalties associated with moving through water, allowing the user to operate underwater as easily as in air. Note that this does not include either water breathing functionality or swimming ability (those are sold separately). |

### Sharkskin

{{SR5:Cyberware Template|Type=Basic|Device=Sharkskin

|Essence=0.25|Availability=8|Cost=8,000

|Special=;Benefit:+1 [[Reach}} in unarmed combat
