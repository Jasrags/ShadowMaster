...
- [2 Assault Cannon](#Assault_Cannon)

- [3 Capsule Rounds](#Capsule_Rounds)

- [4 Explosive Rounds](#Explosive_Rounds)

- [5 EX-Explosive Rounds](#EX-Explosive_Rounds)

- [6 Flare Rounds](#Flare_Rounds)

- [7 Flechette Rounds](#Flechette_Rounds)

- [8 Frangible Rounds](#Frangible_Rounds)

- [9 Gel Rounds](#Gel_Rounds)

- [10 Hollow Points](#Hollow_Points)

- [11 Injection Darts](#Injection_Darts)

- [12 Regular Ammo](#Regular_Ammo)

- [13 Stick-n-Shock](#Stick-n-Shock)

- [14 Tracer](#Tracer)

- [15 Tracker Rounds](#Tracker_Rounds)

- [16 Taser Dart](#Taser_Dart)

- [17 Net Gun](#Net_Gun)

- [18 Net Gun, XL](#Net_Gun.2C_XL)

- [19 Shocknet](#Shocknet)

- [20 Fuel Cannister](#Fuel_Cannister)

- [21 AV Rounds](#AV_Rounds)

- [22 Gyrojet ammo](#Gyrojet_ammo)
...
| On Hit Rounds carry a liquid that, upon impact, splashes the target. Damage and AP are for the damage of the shot itself. A successful hit, including a Grazing Hit, means the capsule ruptures and the target faces damage from the chemical. Fill The rounds listed are empty but can be filled with a chemical with a Logic + Armorer [Mental] (12, 1 minute) Extended Test for each round. A single dose of chemical fills 5 rounds and must be purchased separately. Range all use Light Pistol ranges, no matter what weapon fires them. |  |
...
| Flare rounds are intended to be shot into the air and act as a signal or location marker. They ignite upon firing and explode into a shower of burning sparks at 60 meters. On Hit Targets struck by a flare round may catch fire (see p. 171, SR5). The first numbers listed are for a round impacting at less than 60 meters. The second is for a round impacting between 60 and 62 meters. These rounds are ineffective beyond 62 meters no matter what weapon they are loaded into. |  |
...
| Barriers rounds face double the Armor against all Barriers. |  |
