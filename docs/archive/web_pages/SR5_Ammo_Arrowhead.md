...
- [2 Injection arrow](#Injection_arrow)

- [3 Barbed Head](#Barbed_Head)

- [4 Explosive Head](#Explosive_Head)

- [5 Hammerhead](#Hammerhead)

- [6 Incendiary Head](#Incendiary_Head)

- [7 Mono Tips](#Mono_Tips)

- [8 Screamer Head](#Screamer_Head)

- [9 Seeker Shafts](#Seeker_Shafts)

- [10 Stick-N-Shock](#Stick-N-Shock)
  - [10.1 Static Shaft](#Static_Shaft)
...
[![SR5 Ammo Barbed Head.png](/Shadowrun/images/4/46/SR5_Ammo_Barbed_Head.png)](/Shadowrun/index.php/File:SR5_Ammo_Barbed_Head.png)

| DV  | AP  | ACC MOD | DV MOD | AP MOD | AVAIL | COST | SOURCE  |
| --- | --- | ------- | ------ | ------ | ----- | ---- | ------- |
| +1  | -   | -       | -      | -      | 5R    | 10¥  | SR5:R&G |

| Remove Arrow Removing a barbed arrow without doing further damage to the target requires a **First Aid + Logic [Mental] (3) Test** . Failure results in a number of boxes of **Physical damage equal to 3 – hits, unresisted** . | |
...
| On Contact On a successful hit, even a Grazing Hit, the arrow erupts in white phosphorous fire with a **DV of 8P and -6 AP** . The WP continues to burn for **3 Combat Turns** , causing **6P (–4 AP) of fire damage each turn** ( **Fire Damage** ) and possibly igniting and damaging items on the character each turn. Wireless Bonus The head can be detonated before impact and split between **two targets within 1 meter** of each other. Both targets roll to avoid the attack separately and neither takes the initial 8P damage, instead just suffering the **6P, –4AP, for 4 Combat Turns, including the current one** . | |
...
| Reset Sound Resetting the sound setting requires a Simple Action and a Logic + Intuition (1) Test. Wireless Bonus The sound resetting can be done as a Free Action, even while in flight. | |
...
| Smartlink Lock On Take a simple action to Lock On. +1 to attack, and negate -2 from circumstantial penalties. Wireless bonus Locking onto a target is a Free Action | |
