...
| -------------- | ------------------------------- | ------ | ----- | -------------------- | ------ |
| **Explosives** | **Ammonium nitrate**            | 4      | 5     | 80¥ per KG           | R&G    |
| **Explosives** | **ANFO**                        | 6      | 7     | 100¥ per KG          | R&G    |
| **Explosives** | **Binary**                      | 1-20   | 18F   | Rating x 125¥ per KG | R&G    |
| **Explosives** | **Commercial**                  | 5      | 8R    | 100¥ per KG          | Core   |
| **Explosives** | **Detonating Cord, Low Yield**  | 3      | 10R   | 100¥ per meter       | R&G    |
| **Explosives** | **Detonating Cord, High Yield** | 6      | 14R   | 150¥ per meter       | R&G    |
| **Explosives** | **Dynamite**                    | 3      | 8R    | 350¥ per KG          | R&G    |
| **Explosives** | **Foam**                        | 6-25   | 12F   | Rating x 100¥ per KG | Core   |
| **Explosives** | **Linear Charge**               | 1-25   | 16R   | Rating x 250¥ per KG | R&G    |
| **Explosives** | **Liquid**                      | 1-25   | 16F   | Rating x 150¥ per KG | R&G    |
| **Explosives** | **Nitroglycerin**               | 6      | 11R   | 350¥ per KG          | R&G    |
| **Explosives** | **Plastic**                     | 6-25   | 16F   | Rating x 100¥ per KG | Core   |
| **Explosives** | **TNT**                         | 5      | 12R   | 200¥ per KG          | R&G    |

## Contents

- [1 Ammonium nitrate](#Ammonium_nitrate)
...
- [5 Det Cord](#Det_Cord)
  - [5.1 Detonating Cord, Low Yield](#Detonating_Cord.2C_Low_Yield)
  - [5.2 Detonating Cord, High Yield](#Detonating_Cord.2C_High_Yield)

- [6 Dynamite](#Dynamite)

- [7 Foam](#Foam)

- [8 Linear Charge](#Linear_Charge)

- [9 Liquid](#Liquid)

- [10 Nitroglycerin](#Nitroglycerin)
...
| RATING | AVAIL | COST                 | SOURCE |
| ------ | ----- | -------------------- | ------ |
| 1-20   | 18F   | Rating x 125¥ per Kg | R&G    |
...
| RATING | AVAIL | COST           | SOURCE |
| ------ | ----- | -------------- | ------ |
| 3      | 10R   | 100¥ per meter | R&G    |

| |

### Detonating Cord, High Yield

| RATING | AVAIL | COST           | SOURCE |
| ------ | ----- | -------------- | ------ |
| 6      | 14R   | 150¥ per meter | R&G    |
...
| Dynamite is typically packed in sticks weighting 0.25 kilograms each, but individual sticks can be taped together quickly to create larger charges. Dynamite is typically sold per kilogram. Although a powerful explosive on its own, dynamite can also be used as a primer for other explosives, such as ANFO. |

## Foam

| RATING | AVAIL | COST                 | SOURCE |
| ------ | ----- | -------------------- | ------ |
| 6-25   | 18F   | Rating x 100¥ per Kg | Core   |
...
| RATING | AVAIL | COST                 | SOURCE |
| ------ | ----- | -------------------- | ------ |
| 1-25   | 16R   | Rating x 250¥ per Kg | R&G    |
...
| RATING | AVAIL | COST                 | SOURCE |
| ------ | ----- | -------------------- | ------ |
| 1-25   | 16F   | Rating x 150¥ per Kg | R&G    |
...
| RATING | AVAIL | COST                 | SOURCE |
| ------ | ----- | -------------------- | ------ |
| 6-25   | 16F   | Rating x 100¥ per Kg | Core   |
...
| RATING | AVAIL | COST        | SOURCE |
| ------ | ----- | ----------- | ------ |
| 5      | 12R   | 200¥ per Kg | R&G    |

| The standard by which all other explosives are measured, trinitrotoluene has been used as an explosive compound for 200 years. TNT is highly regulated and hard to obtain legally without proper permits and licenses. TNT is available in blocks of varying weight that can either be cut up when smaller amounts are needed or taped together for larger charges. Any kind of detonator can be used to set off TNT. |
