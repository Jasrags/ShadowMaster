...
- Weapon status indicator (ammo count, operational condition, possible incursion)
...
- Combat Mode. + 1 to one of the following combat skills of the player’s choice: Close Combat, Automatics, Longarms, Pistols, Unarmed Combat. Player can switch to a different skill during combat as a simple action.

```
MODEL DR AVAIL COST
Novatech Tactician 5 18R 325,000
```
...
```
MODEL DR AVAIL COST
ComPac-Esprit General 6 18F 855,000
```
