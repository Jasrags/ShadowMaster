...
- [1 TIPS FOR CHARACTER CREATION](#TIPS_FOR_CHARACTER_CREATION)

- [2 COMMON CHARACTER TYPES AND THEIR ROLES](#COMMON_CHARACTER_TYPES_AND_THEIR_ROLES)

- [3 EXAMPLE](#EXAMPLE)
  - [3.1 GETTING STARTED](#GETTING_STARTED)
  - [3.2 JAMES](#JAMES)
  - [3.3 ROB](#ROB)
  - [3.4 KYRA](#KYRA)

- [4 ALTERNATE GAMEPLAY](#ALTERNATE_GAMEPLAY)
  - [4.1 STREET-LEVEL PLAY](#STREET-LEVEL_PLAY)
  - [4.2 PRIME RUNNER PLAY](#PRIME_RUNNER_PLAY)
...
Technomancer
Natural Hardening (Cost: 10 Karma)

### ROB

Street Samurai
SINner [National]: (Bonus: 5 Karma)
Exceptional Attribute [Strength]: (Cost: 14 Karma)
[Dependent on gamemaster approval]

### KYRA

Mystic Adept
Mentor Spirit (Cost: 5 Karma)
Focused Concentration [Rating 2] (Cost: 8 Karma)
