...
- [1 Vehicle Equipment](#Vehicle_Equipment)
  - [1.1 Rigger interface](#Rigger_interface)
  - [1.2 Standard weapon mount](#Standard_weapon_mount)
    - [1.2.1 Heavy weapon mount](#Heavy_weapon_mount)
    - [1.2.2 Manual operation](#Manual_operation)
  - [1.3 Morphing License Plate](#Morphing_License_Plate)
  - [1.4 Spoof Chip](#Spoof_Chip)
  - [1.5 Road Strips](#Road_Strips)
    - [1.5.1 Spike Strip](#Spike_Strip)
    - [1.5.2 Zapper Strip](#Zapper_Strip)
    - [1.5.3 Tracking Strip](#Tracking_Strip)
  - [1.6 Special Tires](#Special_Tires)
    - [1.6.1 Off-road Tires](#Off-road_Tires)
    - [1.6.2 Racing Tires](#Racing_Tires)
    - [1.6.3 Run Flat Tires](#Run_Flat_Tires)
  - [1.7 Tool Kit](#Tool_Kit)

- [2 Power Train Modifications](#Power_Train_Modifications)
  - [2.1 Acceleration Enhancement](#Acceleration_Enhancement)
    - [2.1.1 Acceleration Enhancement R1](#Acceleration_Enhancement_R1)
    - [2.1.2 Acceleration Enhancement R2](#Acceleration_Enhancement_R2)
  - [2.2 Gecko Tips](#Gecko_Tips)
    - [2.2.1 Gecko Tips (Body 1–3)](#Gecko_Tips_.28Body_1.E2.80.933.29)
    - [2.2.2 Gecko Tips (Body 4–6)](#Gecko_Tips_.28Body_4.E2.80.936.29)
  - [2.3 Gliding System](#Gliding_System)
    - [2.3.1 Gliding System (Body <= 12)](#Gliding_System_.28Body_.3C.3D_12.29)
    - [2.3.2 Gliding System (Body > 12)](#Gliding_System_.28Body_.3E_12.29)
  - [2.4 Handling Enhancement](#Handling_Enhancement)
    - [2.4.1 Handling Enhancement (R1)](#Handling_Enhancement_.28R1.29)
    - [2.4.2 Handling Enhancement (R2)](#Handling_Enhancement_.28R2.29)
    - [2.4.3 Handling Enhancement (R3)](#Handling_Enhancement_.28R3.29)
  - [2.5 Improved Economy](#Improved_Economy)
  - [2.6 Manual Control Override](#Manual_Control_Override)
  - [2.7 Multifuel Engine](#Multifuel_Engine)
  - [2.8 Off-Road Suspension](#Off-Road_Suspension)
  - [2.9 Removed Manual Controls](#Removed_Manual_Controls)
  - [2.10 Rigger Cocoon](#Rigger_Cocoon)
  - [2.11 Rocket Booster](#Rocket_Booster)
  - [2.12 Secondary Manual Controls](#Secondary_Manual_Controls)
  - [2.13 Secondary Propulsion](#Secondary_Propulsion)
    - [2.13.1 Secondary Propulsion (Amphibious)](#Secondary_Propulsion_.28Amphibious.29)
      - [2.13.1.1 Surface](#Surface)
      - [2.13.1.2 Submersible](#Submersible)
    - [2.13.2 Secondary Propulsion (Hovercraft)](#Secondary_Propulsion_.28Hovercraft.29)
    - [2.13.3 Secondary Propulsion (Rotor)](#Secondary_Propulsion_.28Rotor.29)
    - [2.13.4 Secondary Propulsion (Tracked)](#Secondary_Propulsion_.28Tracked.29)
  - [2.14 Secondary Propulsion (Walker)](#Secondary_Propulsion_.28Walker.29)
  - [2.15 Speed Enhancement](#Speed_Enhancement)
    - [2.15.1 Speed Enhancement (R1)](#Speed_Enhancement_.28R1.29)
    - [2.15.2 Speed Enhancement (R2)](#Speed_Enhancement_.28R2.29)
    - [2.15.3 Speed Enhancement (R3)](#Speed_Enhancement_.28R3.29)

- [3 Protection Modifications](#Protection_Modifications)
  - [3.1 Anti-Theft System](#Anti-Theft_System)
    - [3.1.1 Anti-Theft System (R1)](#Anti-Theft_System_.28R1.29)
    - [3.1.2 Anti-Theft System (R2)](#Anti-Theft_System_.28R2.29)
    - [3.1.3 Anti-Theft System (R3)](#Anti-Theft_System_.28R3.29)
    - [3.1.4 Anti-Theft System (R4)](#Anti-Theft_System_.28R4.29)
  - [3.2 Armor](#Armor)
    - [3.2.1 Armor (Standard)](#Armor_.28Standard.29)
    - [3.2.2 Armor (Concealed)](#Armor_.28Concealed.29)
  - [3.3 Passenger Protection System (Rating 1-6)](#Passenger_Protection_System_.28Rating_1-6.29)
  - [3.4 Personal Armor (Rating 1-10)](#Personal_Armor_.28Rating_1-10.29)
  - [3.5 Special Armor Modification](#Special_Armor_Modification)

- [4 Weapon Modifications](#Weapon_Modifications)
  - [4.1 Ammo Bin](#Ammo_Bin)
  - [4.2 Drone Racks](#Drone_Racks)
    - [4.2.1 Standard Drone Rack (Mini)](#Standard_Drone_Rack_.28Mini.29)
    - [4.2.2 Standard Drone Rack (Small)](#Standard_Drone_Rack_.28Small.29)
    - [4.2.3 Standard Drone Rack (Medium)](#Standard_Drone_Rack_.28Medium.29)
    - [4.2.4 Standard Drone Rack (Large)](#Standard_Drone_Rack_.28Large.29)
    - [4.2.5 Landing Drone Rack (Mini)](#Landing_Drone_Rack_.28Mini.29)
    - [4.2.6 Landing Drone Rack (Small)](#Landing_Drone_Rack_.28Small.29)
    - [4.2.7 Landing Drone Rack (Medium)](#Landing_Drone_Rack_.28Medium.29)
    - [4.2.8 Landing Drone Rack (Large)](#Landing_Drone_Rack_.28Large.29)
  - [4.3 Gun Port](#Gun_Port)
  - [4.4 Missile Defense System](#Missile_Defense_System)
  - [4.5 Oil Slick Sprayer](#Oil_Slick_Sprayer)
  - [4.6 Ram Plate](#Ram_Plate)
  - [4.7 Road Strip Ejector](#Road_Strip_Ejector)
  - [4.8 Smoke Projector](#Smoke_Projector)
  - [4.9 Weapon Mount](#Weapon_Mount)
    - [4.9.1 Weapon Mounts](#Weapon_Mounts)
      - [4.9.1.1 Weapon Mount (Light)](#Weapon_Mount_.28Light.29)
      - [4.9.1.2 Weapon Mount (Standard)](#Weapon_Mount_.28Standard.29)
      - [4.9.1.3 Weapon Mount (Heavy)](#Weapon_Mount_.28Heavy.29)
    - [4.9.2 Visibility](#Visibility)
      - [4.9.2.1 External Visibility](#External_Visibility)
      - [4.9.2.2 Internal Visibility](#Internal_Visibility)
      - [4.9.2.3 Concealed Visibility](#Concealed_Visibility)
    - [4.9.3 Flexibility](#Flexibility)
      - [4.9.3.1 Fixed Flexibility](#Fixed_Flexibility)
      - [4.9.3.2 Flexible Flexibility](#Flexible_Flexibility)
      - [4.9.3.3 Turret Flexibility](#Turret_Flexibility)
    - [4.9.4 Control](#Control)
      - [4.9.4.1 Remote Control](#Remote_Control)
      - [4.9.4.2 Manual Control](#Manual_Control)
      - [4.9.4.3 Armored Manual Control](#Armored_Manual_Control)

- [5 Body Modifications](#Body_Modifications)
  - [5.1 Assembly/Disassembly](#Assembly.2FDisassembly)
  - [5.2 Chameleon Coating](#Chameleon_Coating)
  - [5.3 Ejection Seat](#Ejection_Seat)
  - [5.4 Extra Entry/Exit Points](#Extra_Entry.2FExit_Points)
  - [5.5 Extreme Environment Modification](#Extreme_Environment_Modification)
  - [5.6 Increased Seating](#Increased_Seating)
  - [5.7 Life Support](#Life_Support)
    - [5.7.1 Life Support (L1)](#Life_Support_.28L1.29)
    - [5.7.2 Life Support (L2)](#Life_Support_.28L2.29)
  - [5.8 Mechanical Arm](#Mechanical_Arm)
    - [5.8.1 Mechanical Arm (Basic)](#Mechanical_Arm_.28Basic.29)
    - [5.8.2 Mechanical Arm (Articulated)](#Mechanical_Arm_.28Articulated.29)
  - [5.9 Nanomaintenance System (Rating 1-4)](#Nanomaintenance_System_.28Rating_1-4.29)
  - [5.10 Realistic Features (Rating 1-4)](#Realistic_Features_.28Rating_1-4.29)
  - [5.11 Smuggling Compartment](#Smuggling_Compartment)
    - [5.11.1 Smuggling Compartment (Shielding)](#Smuggling_Compartment_.28Shielding.29)
  - [5.12 Special Equipment](#Special_Equipment)
  - [5.13 Valkyrie Module](#Valkyrie_Module)
  - [5.14 Winch](#Winch)
    - [5.14.1 Winch (Basic)](#Winch_.28Basic.29)
    - [5.14.2 Winch (Enhanced)](#Winch_.28Enhanced.29)
  - [5.15 Workshop](#Workshop)

- [6 Electromagnetic Modifications](#Electromagnetic_Modifications)
  - [6.1 Electromagnetic Shielding](#Electromagnetic_Shielding)
  - [6.2 ECM](#ECM)
  - [6.3 Gridlink](#Gridlink)
  - [6.4 Gridlink Override](#Gridlink_Override)
  - [6.5 Pilot Enhancement (R1–3)](#Pilot_Enhancement_.28R1.E2.80.933.29)
  - [6.6 Pilot Enhancement (R4–6)](#Pilot_Enhancement_.28R4.E2.80.936.29)
  - [6.7 Retrans Unit](#Retrans_Unit)
  - [6.8 Satellite Link](#Satellite_Link)
  - [6.9 Sensor Enhancement (R1–3)](#Sensor_Enhancement_.28R1.E2.80.933.29)
  - [6.10 Sensor Enhancement (R4–6)](#Sensor_Enhancement_.28R4.E2.80.936.29)
  - [6.11 Signature Masking (R1–6)](#Signature_Masking_.28R1.E2.80.936.29)
  - [6.12 SunCell](#SunCell)
  - [6.13 Touch Sensors](#Touch_Sensors)

- [7 Cosmetic Modifications](#Cosmetic_Modifications)
  - [7.1 Amenities](#Amenities)
    - [7.1.1 Amenities (Squatter)](#Amenities_.28Squatter.29)
    - [7.1.2 Amenities (Middle)](#Amenities_.28Middle.29)
    - [7.1.3 Amenities (High)](#Amenities_.28High.29)
    - [7.1.4 Luxury](#Luxury)
  - [7.2 Enhanced Image Screens](#Enhanced_Image_Screens)
  - [7.3 Metahuman Adjustment](#Metahuman_Adjustment)
  - [7.4 Rigger Interface](#Rigger_Interface_2)
  - [7.5 Interior Cameras](#Interior_Cameras)
  - [7.6 Searchlight](#Searchlight)
  - [7.7 Vehicle Tag Eraser](#Vehicle_Tag_Eraser)
  - [7.8 Yerzed Out (R1–4)](#Yerzed_Out_.28R1.E2.80.934.29)
...
| | |
| Vehicles may be equipped with a number of weapon mounts equal to their unaugmented Body ÷ 3 (round down). Standard weapon mounts may hold any assault rifle or smaller-sized weapon and 250 rounds of ammo. |
...
| | |
| Heavy weapon mounts count as two weapon mounts and can hold any weapon and up to 500 rounds of belted ammo or up to Body rockets/missiles. All weapon mounts are operated remotely and can target a ninety-degree arc of fire (horizontal and vertical). |
...
| | |
| The tracking strip is a subtle way to gather information about vehicles that pass by. Once deployed, whenever a vehicle passes over a tracking strip, it “fires” a that attaches itself to the vehicle. A tracking strip contains fifty stealth tags. |
...
| | |
| Designed specifically for rough terrain, these tires are not as effective as standard tires on standard roads. When equipped, the vehicle’s off-road Handling is increased by +1, and on-road Handling is reduce by –1. Off-road tires are also considered Run Flat Tires. |
...
| | |
| The flip-side of off-road tires, racing tires are designed to maximize vehicle performance in urban conditions. When equipped, the vehicle’s on-road Handling is increased by +1 and off-road Handling is reduced by –1. |
...
It never hurts to be prepared! A smart vehicle owner will purchase at least an Automotive Mechanic in their vehicle to affect emergency repairs, and possibly others if the vehicle has more exotic equipment.
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST            | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | --------------- | -------- |
| 4     | 12        | Shop  | -     | 6     | Accel x 10,000¥ | SR5:R5.0 |

| | |
| |

### Acceleration Enhancement R2

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST            | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | --------------- | -------- |
| 8     | 24        | Facility | -     | 6     | Accel x 25,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------------- | -------- |
| 5     | 16        | Facility | -     | 12R   | Body x 3,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------------- | -------- |
| 10    | 24        | Facility | -     | 16R   | Body x 4,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST           | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | -------------- | -------- |
| 4     | 8         | Shop  | -     | 6     | Handl x 2,000¥ | SR5:R5.0 |

| | |
| |

### Handling Enhancement (R2)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST           | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | -------------- | -------- |
| 10    | 16        | Facility | -     | 8     | Handl x 5,000¥ | SR5:R5.0 |

| | |
| |

### Handling Enhancement (R3)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST            | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | --------------- | -------- |
| 18    | 24        | Facility | -     | 10    | Handl x 12,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------ | -------- |
| 2     | 12        | Facility | -     | 4     | 7,500¥ | SR5:R5.0 |

| | |
| With this modification, the fuel consumption of the vehicle has been optimized to use the minimum amount necessary for standard operation. Additionally, the vehicle is fitted with a variety of different means to gather operational power from the environment around it including sunlight, static electricity, and wind. A vehicle with improved economy doubles its operational time as long as it is operating within normal parameters—no high speed chases. |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 4     | 20        | Shop  | -     | 10    | Body x 1,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL   | COST        | SOURCE   |
| ----- | --------- | ----- | ----- | ------- | ----------- | -------- |
| 8     | Shop      | -     | 4     | Vehicle | cost¥ x 25% | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ---- | -------- |
| 1     | Shop      | -     | 4     | 2     | 200¥ | SR5:R5.0 |

| | |
| Riggers who are completely confident in their Matrix skills and security but worried about their lack of physical security will often add a removed manual controls modification. Almost all vehicles in the 2070s are capable of being piloted by either electronic or manual controls. With this modification, the owner simply removes the option for manual controls, relying entirely on the electronic ones. Anyone wishing to pilot the vehicle who is not the owner must succeed on a Control Device Matrix action (p. 238, SR5). |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------------- | -------- |
| 10    | 36        | Facility | -     | 16F   | Body x 5,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST        | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ----------- | -------- |
| 4     | 10        | Shop  | -     | 6     | Body x 200¥ | SR5:R5.0 |

| | |
| With the surface version, the vehicle is able to float on top of the water. This could involve a variety of systems including a secondary hull shaped to displace an appropriate amount of water, inflatable skirts or ballasts that expand to create flotation, or pontoons attached to the hull of the vehicle. Regardless of the exact form, the modification is fairly extensive, and it is immediately obvious to any observer that something dramatic has been done to the vehicle. When operating on water, the vehicle can use its normal means of propulsion or a low-powered propeller. If the latter is used, speed and maneuverability are fairly limited, but the vehicle at least functions. It probably wouldn’t do well crossing an ocean or large lake, but it can easily get across a river, sound, or bay. |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 8     | 20        | Shop  | -     | 12R   | Body x 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 8     | 16        | Shop  | -     | 12    | Body x 1,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------------- | -------- |
| 10    | 24        | Facility | -     | 12R   | Body x 3,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 8     | 16        | Shop  | -     | 12    | Body x 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST           | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | -------------- | -------- |
| 5     | 8         | Shop  | -     | 6     | Speed x 2,000¥ | SR5:R5.0 |

| | |
| |

### Speed Enhancement (R2)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST           | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | -------------- | -------- |
| 14    | 16        | Facility | -     | 8     | Speed x 5,000¥ | SR5:R5.0 |

| | |
| |

### Speed Enhancement (R3)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST            | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | --------------- | -------- |
| 20    | 24        | Facility | -     | 12    | Speed x 12,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------ | -------- |
| 4     | 12        | Shop  | -     | 8R    | 2,500¥ | SR5:R5.0 |

| | |
| If all of that is just for soft-ass corporate drones, then Rating 3 may be for you. This level includes all of the previous features, with the addition of an electro-shock system inflicting 9S(e), or a gas release system equipped with the of your choice. |
...
| SLOTS | THRESHOLD | TOOLS | SKILL       | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | ----------- | ----- | ------ | -------- |
| 6     | 16        | Shop  | Demolitions | 12F   | 5,000¥ | SR5:R5.0 |

| | |
| Rating 4 is the final word in vehicle protection; it includes all of the previous level’s features and adds a remote triggered self-destruct option. The modified vehicle is reduced to medium-to-small component parts. The explosion has a base damage of 12P and –2 AP, with damage from the blast –2/m. |
...
| SLOTS      | THRESHOLD  | TOOLS | SKILL   | AVAIL | COST          | SOURCE   |
| ---------- | ---------- | ----- | ------- | ----- | ------------- | -------- |
| Rating x 2 | Rating x 2 | Shop  | Armorer | 6R    | Rating x 500¥ | SR5:R5.0 |
...
| SLOTS      | THRESHOLD  | TOOLS | SKILL   | AVAIL | COST            | SOURCE   |
| ---------- | ---------- | ----- | ------- | ----- | --------------- | -------- |
| Rating x 3 | Rating x 3 | Shop  | Armorer | 12R   | Rating x 3,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD  | TOOLS | SKILL | AVAIL | COST            | SOURCE   |
| ----- | ---------- | ----- | ----- | ----- | --------------- | -------- |
| 2     | Rating x 4 | Shop  | -     | 6     | Rating x 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD  | TOOLS | SKILL   | AVAIL     | COST          | SOURCE   |
| ----- | ---------- | ----- | ------- | --------- | ------------- | -------- |
| 2     | Rating x 2 | Shop  | Armorer | (Rating)R | Rating x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL   | AVAIL    | COST          | SOURCE   |
| ----- | --------- | ----- | ------- | -------- | ------------- | -------- |
| 2     | 12        | Shop  | Armorer | (As Mod) | (As Mod) x 2¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL   | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | ------- | ----- | ---- | -------- |
| 1     | 4         | Shop  | Armorer | 6R    | 200¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST    | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------- | -------- |
| 4     | 14        | Facility | -     | 8     | 10,000¥ | SR5:R5.0 |

| | |
| |

### Landing Drone Rack (Large)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST    | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------- | -------- |
| 5     | 20        | Facility | -     | 12    | 20,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL    | AVAIL | COST    | SOURCE   |
| ----- | --------- | -------- | -------- | ----- | ------- | -------- |
| 3     | 16        | Facility | Software | 12R   | 15,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 2     | 10        | Shop  | -     | 10F   | 800¥ + strips | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST                           | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------------------------ | -------- |
| 2     | 8         | Shop  | -     | 6R    | 750¥ (+100¥ for Thermal Smoke) | SR5:R5.0 |

| | |
| Another oldie but a goodie, the smoke projector continues to prove that simple never goes out of style. One or two canisters with aerosol nozzles are attached to the vehicle, releasing a huge cloud of dense smoke on command with a Free Action. Once deployed, all actions of vehicles up to one hundred meters behind the vehicle are affected by the Moderate Smoke Visibility Modifier. For a little bit more nuyen, the system can be installed with thermal smoke. |
...
| SLOTS | THRESHOLD | TOOLS | SKILL   | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | ------- | ----- | ---- | -------- |
| 1     | 4         | Kit   | Armorer | 6F    | 750¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL   | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | ------- | ----- | ------ | -------- |
| 2     | 6         | Shop  | Armorer | 8F    | 1,500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL   | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | ------- | ----- | ------ | -------- |
| 4     | 10        | Shop  | Armorer | 12F   | 4,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST    | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------- | -------- |
| +2    | +12       | Facility | -     | +6    | +5,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST  | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ----- | -------- |
| +1    | +4        | Shop  | -     | +1    | +500¥ | SR5:R5.0 |

| | |
| |

#### Armored Manual Control

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST    | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------- | -------- |
| +2    | +6        | Shop  | -     | +4    | +1,500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD         | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | ----------------- | -------- | ----- | ----- | ------ | -------- |
| 2     | Body x 4 (Min. 1) | Facility | -     | 6     | 1,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------------- | -------- |
| 2     | 10        | Facility | -     | 12F   | Body x 1,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST        | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ----------- | -------- |
| 2     | 10        | Shop  | -     | 8     | Body x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL | AVAIL | COST          | SOURCE   |
| ----- | --------- | ----- | ----- | ----- | ------------- | -------- |
| 4     | 20        | Shop  | -     | 12    | Body x 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------ | -------- |
| 3     | 16        | Facility | -     | 6     | 5,000¥ | SR5:R5.0 |
...
| SLOTS  | THRESHOLD  | TOOLS | SKILL | AVAIL    | COST            | SOURCE   |
| ------ | ---------- | ----- | ----- | -------- | --------------- | -------- |
| Rating | Rating x 4 | Shop  | -     | (R x 5)R | Rating x 5,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------ | -------- |
| 3     | 16        | Facility | -     | 8F    | 1,500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------ | -------- |
| n/a   | 12        | Facility | -     | 12F   | 3,000¥ | SR5:R5.0 |
...
| SLOTS    | THRESHOLD | TOOLS    | SKILL    | AVAIL    | COST      | SOURCE   |
| -------- | --------- | -------- | -------- | -------- | --------- | -------- |
| variable | variable  | variable | variable | variable | variable¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ------ | -------- |
| 4     | 6         | Shop  | Hardware | 8     | 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST   | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ------ | -------- |
| 2     | 12        | Facility | -     | 8     | 4,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS    | SKILL | AVAIL | COST        | SOURCE   |
| ----- | --------- | -------- | ----- | ----- | ----------- | -------- |
| 2     | 20        | Facility | -     | 6R    | Body x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL    | COST          | SOURCE   |
| ----- | --------- | ----- | -------- | -------- | ------------- | -------- |
| 2     | 20        | Shop  | Hardware | (R x 3)F | Rating x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ---- | -------- |
| 2     | 4         | Shop  | Hardware | 4     | 750¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ------ | -------- |
| 1     | 8         | Kit   | Hardware | 8F    | 1,000¥ | SR5:R5.0 |

| | |
| |

## Pilot Enhancement (R1–3)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS    | THRESHOLD  | TOOLS | SKILL    | AVAIL | COST            | SOURCE   |
| -------- | ---------- | ----- | -------- | ----- | --------------- | -------- |
| [Rating] | Rating x 3 | Kit   | Hardware | R x 2 | Rating x 2,000¥ | SR5:R5.0 |

| | |
| |

## Pilot Enhancement (R4–6)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS    | THRESHOLD  | TOOLS | SKILL    | AVAIL | COST            | SOURCE   |
| -------- | ---------- | ----- | -------- | ----- | --------------- | -------- |
| [Rating] | Rating x 4 | Shop  | Hardware | R x 3 | Rating x 5,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ------ | -------- |
| 2     | 4         | Kit   | Hardware | 8     | 4,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ---- | -------- |
| 1     | 6         | Kit   | Hardware | 6     | 500¥ | SR5:R5.0 |

| | |
| |

## Sensor Enhancement (R1–3)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS    | THRESHOLD  | TOOLS | SKILL    | AVAIL | COST            | SOURCE   |
| -------- | ---------- | ----- | -------- | ----- | --------------- | -------- |
| [Rating] | Rating x 3 | Shop  | Hardware | R x 2 | Rating x 2,000¥ | SR5:R5.0 |

| | |
| |

## Sensor Enhancement (R4–6)
...
## Signature Masking (R1–6)

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| SLOTS    | THRESHOLD  | TOOLS    | SKILL | AVAIL | COST            | SOURCE   |
| -------- | ---------- | -------- | ----- | ----- | --------------- | -------- |
| [Rating] | Rating x 6 | Facility | -     | 14F   | Rating x 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST        | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ----------- | -------- |
| 2     | 16        | Shop  | Hardware | 6     | Body x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST        | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ----------- | -------- |
| 3     | 16        | Shop  | Hardware | 8     | Body x 500¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST   | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ------ | -------- |
| -     | 6         | Kit   | Hardware | 6     | 2,000¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD | TOOLS | SKILL    | AVAIL | COST | SOURCE   |
| ----- | --------- | ----- | -------- | ----- | ---- | -------- |
| -     | 8         | Shop  | Hardware | 6R    | 750¥ | SR5:R5.0 |
...
| SLOTS | THRESHOLD  | TOOLS | SKILL | AVAIL  | COST            | SOURCE   |
| ----- | ---------- | ----- | ----- | ------ | --------------- | -------- |
| -     | Rating x 4 | Shop  | -     | (R x2) | Rating x 1,000¥ | SR5:R5.0 |
