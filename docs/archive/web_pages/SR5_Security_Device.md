...
- [1 Key/Combination lock (Rating 1-6)](#Key.2FCombination_lock_.28Rating_1-6.29)

- [2 Maglock](#Maglock)
  - [2.1 Anti-tamper circuits (Rating 1-4)](#Anti-tamper_circuits_.28Rating_1-4.29)
  - [2.2 Keypad or card reader](#Keypad_or_card_reader)
  - [2.3 Biometric Reader](#Biometric_Reader)
...
Cardreaders verify the authenticity of swipe cards or RFID proximity cards. They can be defeated using the same method as for keypads—by removing the case and tampering with the works. [Maglock passkeys](/Shadowrun/index.php/SR5:Security:B%26E_Gear#Maglock_Passkey_.28Rating_1-4.29 "SR5:Security:B&E Gear") may also be used to defeat cardreaders and don’t require breaking the case open. If a valid keycard is acquired, it can be copied with a [keycard copier](/Shadowrun/index.php/SR5:Security:B%26E_Gear#Keycard_copier_.28Rating_1-6.29 "SR5:Security:B&E Gear") in order to create a forged keycard. Make an Opposed Test between the passkey/forged keycard rating and the maglock rating. If the passkey/forged keycard wins, the maglock opens.
