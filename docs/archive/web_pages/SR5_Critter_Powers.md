...
- [2 Animal Control](#Animal_Control)

- [3 Armor](#Armor)

- [4 Astral Form](#Astral_Form)

- [5 Binding](#Binding)

- [6 Compulsion](#Compulsion)

- [7 Concealment](#Concealment)

- [8 Confusion](#Confusion)

- [9 Corrosive Spit](#Corrosive_Spit)

- [10 Dragonspeech](#Dragonspeech)

- [11 Dual Natured](#Dual_Natured)

- [12 Elemental Attack](#Elemental_Attack)

- [13 Energy Aura](#Energy_Aura)

- [14 Engulf](#Engulf)

- [15 Enhanced Senses](#Enhanced_Senses)

- [16 Essence Drain](#Essence_Drain)

- [17 Fear](#Fear)

- [18 Guard](#Guard)

- [19 Hardened Armor](#Hardened_Armor)

- [20 Hardened Mystic Armor](#Hardened_Mystic_Armor)

- [21 Immunity](#Immunity)

- [22 Infection](#Infection)

- [23 Influence](#Influence)

- [24 Innate Spell](#Innate_Spell)

- [25 Materialization](#Materialization)

- [26 Mimicry](#Mimicry)

- [27 Mist Form](#Mist_Form)

- [28 Movement](#Movement)

- [29 Mystic Armor](#Mystic_Armor)

- [30 Natural Weapon](#Natural_Weapon)

- [31 Noxious Breath](#Noxious_Breath)

- [32 Paralyzing Howl](#Paralyzing_Howl)

- [33 Paralyzing Touch](#Paralyzing_Touch)

- [34 Petrification](#Petrification)

- [35 Psychokinesis](#Psychokinesis)

- [36 Regeneration](#Regeneration)

- [37 Sapience](#Sapience)

- [38 Search](#Search)

- [39 Venom](#Venom)

- [40 Weather Control](#Weather_Control)

- [41 Spirit Powers](#Spirit_Powers)
  - [41.1 Anaphylaxis](#Anaphylaxis)
  - [41.2 Astral Gateway](#Astral_Gateway)
  - [41.3 Aura Masking](#Aura_Masking)
  - [41.4 Banishing Resistance](#Banishing_Resistance)
  - [41.5 Desire Reflection](#Desire_Reflection)
  - [41.6 Deathly Aura](#Deathly_Aura)
  - [41.7 Devouring](#Devouring)
  - [41.8 Divining](#Divining)
  - [41.9 Elemental Attack (pollutant)](#Elemental_Attack_.28pollutant.29)
  - [41.10 Elemental Attack (radiation)](#Elemental_Attack_.28radiation.29)
  - [41.11 Endowment](#Endowment)
  - [41.12 Energy Drain](#Energy_Drain)
  - [41.13 Hive Mind](#Hive_Mind)
  - [41.14 Inhabitation](#Inhabitation)
  - [41.15 Magical Guard](#Magical_Guard)
  - [41.16 Mind Link](#Mind_Link)
  - [41.17 Mutagen](#Mutagen)
  - [41.18 Pestilence](#Pestilence)
  - [41.19 Possession](#Possession)
  - [41.20 Quake](#Quake)
  - [41.21 Realistic Form](#Realistic_Form)
  - [41.22 Reinforcement](#Reinforcement)
  - [41.23 Sense Link](#Sense_Link)
  - [41.24 Shadow Cloak](#Shadow_Cloak)
  - [41.25 Silence](#Silence)
  - [41.26 Sonic Projection](#Sonic_Projection)
  - [41.27 Storm](#Storm)

- [42 Free Spirit Powers](#Free_Spirit_Powers)
  - [42.1 Astral Projection](#Astral_Projection)
  - [42.2 Mutable Form](#Mutable_Form)
  - [42.3 Personal Domain](#Personal_Domain)
  - [42.4 Regeneration](#Regeneration_2)
  - [42.5 Spirit Pact](#Spirit_Pact)

- [43 Greater Spirit Powers](#Greater_Spirit_Powers)
  - [43.1 Hidden Life](#Hidden_Life)
  - [43.2 Energy Drain (karma)](#Energy_Drain_.28karma.29)
  - [43.3 Vessel Trading](#Vessel_Trading)
  - [43.4 Wealth](#Wealth)
...
This critter is surrounded by a field of damaging energy, which can take the form of **[fire](/Shadowrun/index.php/SR5:Combat_Rules:Elemental_Damage#Fire_Damage "SR5:Combat Rules:Elemental Damage")**, **[electricity](/Shadowrun/index.php/SR5:Combat_Rules:Elemental_Damage#Electricity_Damage "SR5:Combat Rules:Elemental Damage")**, **[cold](/Shadowrun/index.php/SR5:Combat_Rules:Elemental_Damage#Cold_Damage "SR5:Combat Rules:Elemental Damage")**, or the like. The power has a specific element type—for example, spirits of fire have Energy Aura (Fire). The critter adds its Magic to the Damage Value of any melee attack it makes. The **[damage may have a specific type](/Shadowrun/index.php/SR5:Combat_Rules:Elemental_Damage "SR5:Combat Rules:Elemental Damage")** and has an AP of –(critter’s Magic).
...
Fire Engulf
: The victim resists **[Fire damage](/Shadowrun/index.php/SR5:Combat_Rules:Elemental_Damage#Fire_Damage "SR5:Combat Rules:Elemental Damage")**.
...
This power enables a critter to move an object with his mind. It’s similar to the [Magic Fingers](/Shadowrun/index.php/SR5:Spells:Manipulation#Magic_Fingers "SR5:Spells:Manipulation") spell (p. 294), acting as a magical “hand” with Strength and Agility equal to the number of hits scored on a Magic + Willpower Test.
...
Sapient critters are self-aware, capable of making their own choices, and are generally at or above the level of Homo sapiens. While most critters are considered **[Unaware](/Shadowrun/index.php/SR5:Skill_List "SR5:Skill List")** of any skill they don’t possess, sapient critters are merely **[Untrained](/Shadowrun/index.php/SR5:Skill_List "SR5:Skill List")** and can default normally. They are also capable of learning new skills if they so choose.
...
SITUATION
Target is more than a kilometer away
Target is a nonliving object or place
...
SITUATION
Target hidden by Concealment power
Target hidden behind mana barrier
...
| Type:   | P       | Range:    | Touch   | Source: | SR5:SG |
| ------- | ------- | --------- | ------- | ------- | ------ |
| Action: | Complex | Duration: | Instant |

Anaphylaxis is a massive systemic reaction induced by a concentrated burst of pollutants from a toxic spirit. Treat this as a toxin attack with the following ratings:

## Astral Gateway

| Type:   | M       | Range:    | LOS (A)   | Source: | SR5:SG |
| ------- | ------- | --------- | --------- | ------- | ------ |
| Action: | Complex | Duration: | Sustained |

The spirit can open an astral rift (p. 28), which forces all nearby objects to become dual-natured and allows even mundanes to astrally project. An astral rift can open to any metaplane the spirit can visit.

## Aura Masking

| Type:   | M    | Range:    | Self      | Source: | SR5:SG |
| ------- | ---- | --------- | --------- | ------- | ------ |
| Action: | Free | Duration: | Sustained |

Sometimes a spir it doesn’ t want someone to assense its natural aura. This power functions like Masking (p. 326, SR5) and Extended Masking metamagics.
...
| Type:   | M       | Range:    | LOS       | Source: | SR5:SG |
| ------- | ------- | --------- | --------- | ------- | ------ |
| Action: | Complex | Duration: | Sustained |

Desire Reflection finds the greatest desire of a single target within line of sight and evokes a full-sensory illusion keyed to the desire in the target’s mind. Certain spirits use this power to draw in potential victims. The spirit itself can appear as a harmless or pleasing aspect of the illusion at will. To use this power the critter must succeed in an Opposed Test pitting its Magic + Intuition against the target’s Willpower + Intuition. If it scores any net hits, the victim falls for the illusion. Otherwise the power fails to affect the victim.
...
| Type:   | P      | Range:    | Special   | Source: | SR5:SG |
| ------- | ------ | --------- | --------- | ------- | ------ |
| Action: | Simple | Duration: | Sustained |
...
| Speed       | 12 hours                            |
| Penetration | 0                                   |
| Power       | critter’s Magic x 2                 |
| Effect      | Stun damage, disorientation, nausea |

| Type:   | P       | Range:    | Special | Source: | SR5:SG |
| ------- | ------- | --------- | ------- | ------- | ------ |
| Action: | Complex | Duration: | Instant |

This attack follows the rules for Elemental Attack (p. 396, SR5) but with the following modifications.
...
This attack follows the rules for Elemental Attack (p. 396, SR5) but causes radiation elemental damage, which results in radiation burns, radiation poisoning, and other serious side effects.
...
| Type:   | M       | Range:    | Touch     | Source: | SR5:SG |
| ------- | ------- | --------- | --------- | ------- | ------ |
| Action: | Complex | Duration: | Sustained |

The spirit grants the use of one of its powers to the target. The spirit may still use the power while the target uses it, and the spirit can grant a power to a number of targets equal to its Magic. No character may gain more than one power from a spirit at a time.

## Energy Drain

| Type:   | M       | Range:    | Touch or LOS | Source: | SR5:SG |
| ------- | ------- | --------- | ------------ | ------- | ------ |
| Action: | Complex | Duration: | Permanent    |

The Energy Drain power is used by a number of dangerous critters and spirits in different ways. Each version of this power is slightly different, depending on the entity using it. Similar to the Essence Drain power (p. 396, SR5), Energy Drain allows the creature to suck life energy from a victim, be it Karma, Force, Magic, or Essence. For some creatures, such as blood spirits, shedim, or insect spirits, this power is Touch range, so a resisting victim must be subdued first or drained unwittingly. Other beings, such as shadow spirits, merely require line of sight for this power, allowing the critter to feed off its victims from afar.
...
In addition to the drain, victims suffer 1 box of damage for each point drained. Depending on the critter, this may be Stun damage (shadow spirits, astral bacteria) or Physical damage (blood spirits, shedim). Victims who take Physical damage appear drained, withered, and hollow, and are sometimes marked permanently (white hair, hair loss, wrinkles, premature aging, or other strange markings).

If a character’s Magic is reduced to 0, he burns out and becomes mundane. If a critter’s Magic is reduced to 0, it dies. If a spirit, sustained/anchored/quickened spell, focus, or mana barrier’s Force is reduced to 0, it is destroyed. If a victim’s Essence is reduced to 0, they die.
...
All insect spirits of a given species controlled by a shaman or a queen/mother possess a constant telepathic bond with one another. Insect spirits may send a telepathic message to one or more spirits in the hive and/or the shaman as a Free Action. The shaman or queen/mother can also use this link to experience any of the hive’s insect spirits (or switch to another spirit) with a Simple Action, similar to the Sense Link power (p. 198) but without range limitations.

The constant buzz of insect spirits in an insect shaman’s mind can be distracting, especially if the hive is agitated. When this occurs, the shaman must succeed in a Magic + Willpower [Mental] (2) Test in order to suppress the background hum and concentrate on something, such as fighting or spellcasting.

## Inhabitation

| Type:   | P    | Range:    | Self    | Source: | SR5:SG |
| ------- | ---- | --------- | ------- | ------- | ------ |
| Action: | Auto | Duration: | Special |
...
| Penetration | –2                                                                                                                                                                                                                      |
| Power       | 8                                                                                                                                                                                                                       |
| Effect      | Stun damage, disorientation, nausea. Disease effects last 1 full day. Each day the disease Power increas es by 2 and the character must make another Toxin Resis tance Test, until the disease’s Power is reduced to 0. |

| Type:   | P    | Range:    | Touch   | Source: | SR5:SG |
| ------- | ---- | --------- | ------- | ------- | ------ |
| Action: | Auto | Duration: | Instant |

The critter carries non-magical, contagious infection that may infect characters that come in contact with it (or its secretions). Treat this disease as a toxin (p. 408, SR5) with the following attributes:
...
| 3    | Furniture shifts; objects fall off shelves in bulk; drivers of land vehicles must make Vehicle Tests. |
| 4    | Ordinary buildings damaged; doors jam; minefields detonate.                                           |
| 5    | Furniture overturns; windows break; entire area considered difficult ground.                          |
| 5    | Freestanding fences, walls, and trees sag or fall over; gas lines are unsafe.                         |
| 6    | Roadways become impassable; some buildings collapse.                                                  |
| 7    | Many buildings collapse, crevasses appear in pavement and open ground.                                |

| Type:   | P       | Range:    | Special | Source: | SR5:SG |
| ------- | ------- | --------- | ------- | ------- | ------ |
| Action: | Complex | Duration: | Instant |

The spirit can create earthquakes with potentially devastating effects. The quake affects an area with a radius of (Force) kilometers, and the shaking persists intermittently for (Force) minutes. Areas especially vulnerable to earthquakes are usually not areas that receive them frequently, as people in vulnerable areas tend to build dwellings with earthquakes in mind. The spirit makes a Magic + Willpower Test and the number of hits represents the magnitude of the quake, as noted on the Quake Table.
...
This power allows a creature to envelop itself in utter darkness, making it appear to be a shadow. Shadow Cloak is useless in full daylight and unnecessary in complete darkness; other lighting conditions make it difficult to see the creature using this power. Apply a –2 dice pool modifier to Perception Tests for detecting the creature in Normal Light, –4 dice pool modifier in Partial Light, and a +1 dice pool modifier in Glare conditions.
...
The spirit can astrally project, just like a magician (p. 313, SR5). This power is only available to spirits with the Inhabitation power. A spirit that does not return to its body after (Force x 2) hours is disrupted.
...
| Type:   | M    | Range:    | LOS       | Source: | SR5:SG |
| ------- | ---- | --------- | --------- | ------- | ------ |
| Action: | Auto | Duration: | Sustained |
...
Greater powers are so dramatic, unusual, or powerful that they can often define an entire encounter with a spirit. Gamemasters should keep these powers rare and limit a spirit to only one of them.
...
The hiding place gains Immunity to Normal Weapons with a Magic equal to the spirit’s and Immunity to Age (p. 397, SR5). If the hidden life holder is destroyed, the life force returns to the spirit, and the spirit is treated normally.
