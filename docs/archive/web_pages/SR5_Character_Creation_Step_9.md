...
- [1 CHARACTER ADVANCEMENT](#CHARACTER_ADVANCEMENT)
...
- [3 ATTRIBUTE AND SKILL TABLES](#ATTRIBUTE_AND_SKILL_TABLES)

- [4 LEARNING COMPLEX FORMS](#LEARNING_COMPLEX_FORMS)

- [5 LEARNING MAGIC](#LEARNING_MAGIC)

- [6 QUALITIES](#QUALITIES)
