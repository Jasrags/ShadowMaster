...
1. **As a player**, I want to browse available cyberware and bioware during character creation so I can choose augmentations that fit my character concept.

2. **As a player**, I want to see the essence cost of each augmentation so I can plan my purchases within my essence budget.

3. **As a player**, I want to select different grades for augmentations so I can balance cost, availability, and essence loss.

4. **As a player**, I want to see how augmentations affect my attributes (e.g., Wired Reflexes increasing Reaction) so I understand the mechanical benefits.

5. **As a player**, I want to be warned when augmentations would reduce my Magic or Resonance below acceptable levels so I don't accidentally cripple my magical character.

6. **As a player**, I want to filter augmentations by category, availability, and restricted status so I can quickly find legal options for creation.

7. **As a player**, I want to customize cyberlimbs with enhancements and accessories so I can create specialized limbs.

8. **As a player**, I want to see my total essence spent and remaining so I know my budget status at all times.

9. **As a player**, I want availability restrictions enforced during creation (max 12, no forbidden items) so my character is legal.

10. **As a player**, I want to see wireless bonuses for cyberware so I can decide whether to enable wireless functionality.

### Gameplay - Viewing

11. **As a player**, I want to see all my installed augmentations on my character sheet so I can reference their effects during play.

12. **As a player**, I want to see attribute bonuses from augmentations reflected in my derived stats so calculations are accurate.

13. **As a player**, I want to see initiative bonuses from cyberware (e.g., Wired Reflexes) in my initiative calculation.

14. **As a player**, I want to see cyberlimb stats (customized attributes) for each limb so I know their capabilities.

15. **As a player**, I want to see essence hole tracking so I understand my peak essence loss and its effect on Magic.

### Gameplay - Management

16. **As a player**, I want to add new augmentations after character creation (via karma and nuyen) so my character can grow.

17. **As a player**, I want to upgrade augmentation grades (e.g., from alpha to beta) so I can reduce essence loss.

18. **As a player**, I want to remove augmentations and track the resulting essence hole so my magical potential is properly calculated.

19. **As a player**, I want to enable or disable wireless bonuses per device so I can manage my Matrix exposure.

20. **As a player**, I want to take damage to specific cyberlimbs and track their condition so combat is properly represented.

### GM Use Cases

21. **As a GM**, I want to see player augmentation lists so I can plan encounters appropriately.

22. **As a GM**, I want to apply EMP or Matrix attacks that disable cyberware so I can challenge augmented characters.

23. **As a GM**, I want to manage NPC augmentations for quick reference during combat.

---

## Acceptance Criteria

### MVP (Phase 1) - Character Creation Foundation ✅

**Data Structures:**
- [x] `CyberwareItem` type with all core fields (catalogId, name, category, grade, essenceCost, etc.)
- [x] `BiowareItem` type with all core fields
- [x] `EssenceHole` type for magic user tracking
- [x] Grade definitions with multipliers (used, standard, alpha, beta, delta for cyberware)
- [x] Category types (12 cyberware, 6 bioware categories)

**Catalog Data:**
- [x] Core cyberware catalog in `core-rulebook.json`
- [x] Core bioware catalog in `core-rulebook.json`
- [x] Grade definitions with essence/cost/availability multipliers
- [x] Basic augmentation rules (maxEssence, maxAvailability, etc.)

**Hooks and Context:**
- [x] `useCyberware()` hook for catalog access with filtering
- [x] `useBioware()` hook for catalog access with filtering
- [x] `useCyberwareGrades()` hook for grade data
- [x] `useBiowareGrades()` hook for grade data
- [x] `useAugmentationRules()` hook for rules access

**Creation UI (Basic):**
- [x] Augmentation section in GearStep
- [x] Basic cyberware/bioware selection
- [x] Essence tracking during creation
- [x] Nuyen cost calculation

### Phase 2 - Enhanced Creation Experience

**Improved UI:**
- [ ] Dedicated AugmentationsStep component (separate from GearStep)
- [ ] Category-based browsing with collapsible sections
- [ ] Grade selector dropdown with cost/essence preview
- [ ] Essence budget visualization (progress bar)
- [ ] Magic/Resonance impact warning for awakened characters
- [ ] Search and filter functionality
- [ ] Availability badge display (restricted/forbidden)

**Cyberlimb System:**
- [ ] Cyberlimb customization interface
- [ ] Base attribute display (STR 3, AGI 3)
- [ ] Capacity tracking for enhancements
- [ ] Enhancement installation UI
- [ ] Cyberlimb accessory management
- [ ] Obvious vs. synthetic appearance selection

**Validation:**
- [ ] Availability limit enforcement (max 12 at creation)
- [ ] Forbidden item blocking with warning
- [ ] Essence minimum warning (0.01 required)
- [ ] Duplicate augmentation prevention
- [ ] Incompatibility checks (e.g., cannot have both cyber-eyes and natural eyes)

### Phase 3 - Gameplay Display

**Character Sheet Sections:**
- [x] Cyberware section with grade and essence display
- [x] Bioware section with grade and essence display
- [ ] Cyberlimb detail cards with stats
- [ ] Nested enhancement display
- [ ] Wireless bonus indicators
- [ ] Total essence summary

**Derived Stats Integration:**
- [ ] Attribute bonuses reflected in character stats
- [ ] Initiative dice bonuses calculated
- [ ] Limit modifiers applied
- [ ] Wound modifier adjustments (pain editor, etc.)

**Visual Design:**
- [ ] Category icons for augmentation types
- [ ] Grade color coding (used=gray, standard=white, alpha=blue, beta=purple, delta=gold)
- [ ] Essence cost formatting (2 decimal places)
- [ ] Capacity bars for cyberlimbs

### Phase 4 - Gameplay Management

**Augmentation Operations:**
- [ ] Add new augmentation (post-creation)
- [ ] Remove augmentation with essence hole tracking
- [ ] Upgrade grade with essence recalculation
- [ ] Toggle wireless bonus status
- [ ] Add notes to individual augmentations

**Essence Hole System:**
- [ ] Track peak essence loss
- [ ] Calculate essence hole on removal
- [ ] Apply Magic/Resonance reduction
- [ ] Display essence hole in character sheet
- [ ] Support essence hole healing (rare magical healing)

**Cyberlimb Damage:**
- [ ] Track damage to individual limbs
- [ ] Limb destruction rules
- [ ] Repair/replacement tracking

### Phase 5 - Advanced Features

**Wireless Matrix Integration:**
- [ ] Track wireless-enabled devices
- [ ] Noise penalty calculations
- [ ] Hacking target generation
- [ ] EMP vulnerability display

**Combat Integration:**
- [ ] Cyberweapon damage calculations
- [ ] Retractable weapon state tracking
- [ ] Dermal plating armor integration
- [ ] Bone lacing damage resistance

**Sourcebook Expansion:**
- [ ] Chrome Flesh augmentation catalog
- [ ] Additional grades (used bioware, genetech)
- [ ] Nanoware category expansion
- [ ] Geneware/Genetech support
