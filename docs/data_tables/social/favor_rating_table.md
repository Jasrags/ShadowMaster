...
| 2      | Low Risk. Loan use of specialized equipment (up to 5,000 nuyen in value). Corporate action requiring the signature of a first-line supervisor.              |
...
| 6      | Major Risk. Loan of specialized equipment (up to 500,000Y in value). Corporate requisition requiring the signature of a senior manager or junior executive. |
