...
_Unless otherwise noted, these dice pool modifiers apply to the acting character's dice pool._

## General Modifiers

| Modifier                                      | Dice Pool Modifier          |
| :-------------------------------------------- | :-------------------------- |
...
| Character has (known) street reputation:      | + (Street Cred, see p. 372) |
| Subject has (known) street reputation:        | - (Street Cred, see p. 372) |
