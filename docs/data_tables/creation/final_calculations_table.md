...
| :------- | :------ | :------------------- |
| Initiative | (Intuition + Reaction) + 1D6 (Roll 1 six-sided die) | Add appropriate attribute and Initiative Dice bonuses |
| Astral Initiative | (Intuition x 2) + 2D6 (Roll 2 six-sided dice) | — |
| Matrix AR Initiative | (Intuition + Reaction) + 1D6 (Roll 1 six-sided die) | — |
| Matrix VR Initiative (Cold Sim) | (Data Processing + Intuition) + 3D6 (Roll 3 six-sided dice) | — |
| Matrix VR Initiative (Hot Sim) | (Data Processing + Intuition) + 4D6 (Roll 4 six-sided dice) | — |
