# Sprite Statistics Table

| Sprite Name    | Attack | Sleaze | Data Processing | Firewall | Initiative  | Initiative Dice | Resonance | Skills                                 | Powers                           |
| :------------- | :----- | :----- | :-------------- | :------- | :---------- | :-------------- | :-------- | :------------------------------------- | :------------------------------- |
...
| Machine Sprite | L+1    | L      | L+3             | L+2      | (L x 2) + 3 | 4D6             | L         | Computer, Electronic Warfare, Hardware | Diagnostics, Gremlins, Stability |

**Note:** L represents the Sprite's Level. All values are calculated based on the Sprite's level.
