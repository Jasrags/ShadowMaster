...
| **Watercraft** | **Boat** | **Aquavida 1** | 2 | 1 | 2 | 20 | 16 | 1 | 3 | 2/8 | 10 | 115,000¥ | SR5:R5.0 |
| **Watercraft** | **Boat** | **Aquavida 2** | 2 | 1 | 2 | 20 | 16 | 1 | 3 | 4/8 | 12 | 135,000¥ | SR5:R5.0 |
| **Watercraft** | **Boat** | **Classic 111** | 3 | 4 | 2 | 24 | 14 | 4 | 4 | 14 | 16 | 14,870¥ | SR5:R5.0 |
...
| **Watercraft** | **Boat** | **Waterbug** | 6 | 3 | 2 | 8 | 4 | 1 | - | 2 | - | 8,000¥ | SR5:R5.0 |
| **Watercraft** | **Boat** | **Waterking** | 3 | 3 | 2 | 14 | 8 | 3 | 2 | 12 | 12 | 74,000¥ | SR5:R5.0 |
| **Watercraft** | **Boat** | **Waveskipper** | 5 | 3 | 2 | 10 | 4 | 1 | - | 1 | - | 10,000¥ | SR5:R5.0 |
...
- [1 Boat](#Boat)
  - [1.1 Samuvani Otter](#Samuvani_Otter)
  - [1.2 Yongkang Gala Trinity](#Yongkang_Gala_Trinity)
  - [1.3 Morgan Cutlass](#Morgan_Cutlass)

- [2 Submarine](#Submarine)
  - [2.1 Proteus Lamprey](#Proteus_Lamprey)
  - [2.2 Vulkan Electronaut](#Vulkan_Electronaut)

# Boat

Boats are operated with the Pilot Watercraft skill.
...
| HANDL | SPEED | ACCEL | BOD | ARMOR | PILOT | SENSOR | SEATS | AVAIL | COST | SOURCE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 4 | 2 | 16 | 10 | 2 | 5 | 4 | 14R | 96,000¥ | Core |

| Weapons 2 Weapon Mounts |  |
...
Submarines are operated with the Pilot Watercraft skill.
...
| HANDL | SPEED | ACCEL | BOD | ARMOR | PILOT | SENSOR | SEATS | AVAIL | COST | SOURCE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3 | 2 | 1 | 6 | 6 | 3 | 6 | 4 | - | 14,000¥ | Core |

| Storage Drone Rack for Single Medium Drone |  |
| This underwater sea-sled is used for underwater inspection and transportation. with riding positions for up to four scuba-equipped passengers (while closest to a submarine, the Lamprey does not actually protect its passengers from the rigors of the deep). Military models of the lamprey are used for aquatic insertions by specially equipped naval spec ops forces, like the UCAS Navy SEAL teams. The lamprey also includes a drone rack for a single seaworthy drone of medium or smaller size for exploring at deeper depths than the passengers can safely go. |
