...
- [1 Flash-Bang](#Flash-Bang)

- [2 Flash-Pak](#Flash-Pak)

- [3 Fragmentation](#Fragmentation)

- [4 High Explosive](#High_Explosive)

- [5 Gas](#Gas)

- [6 Smoke](#Smoke)

- [7 Thermal Smoke](#Thermal_Smoke)

- [8 Paint Grenade](#Paint_Grenade)

## Flash-Bang

[![Blank.png](/Shadowrun/images/d/d2/Blank.png)](/Shadowrun/index.php/File:Blank.png)

| DV | AP | BLAST | AVAIL | COST | SOURCE |
| --- | --- | --- | --- | --- | --- |
...
| Charges 10 Discharge Rate 1 Charge Per Combat Turn Recharge Rate 1 Charge Per 10 Seconds Wireless The strobe sequence can avoid directing strong flashes at the subscribed character; they suffer only half glare penalties from the flash-pak, rounded down. It can recharge by induction, regaining one charge per hour. |  |
