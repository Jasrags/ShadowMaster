...
- [1 Analyze Device](#Analyze_Device)

- [2 Analyze Magic](#Analyze_Magic)

- [3 Analyze Truth](#Analyze_Truth)

- [4 Clairaudience](#Clairaudience)

- [5 Clairvoyance](#Clairvoyance)

- [6 Combat Sense](#Combat_Sense)

- [7 Detect Enemies, Detect Enemies Extended](#Detect_Enemies.2C_Detect_Enemies_Extended)

- [8 Detect Individual](#Detect_Individual)

- [9 Detect Life, Detect Life Extended](#Detect_Life.2C_Detect_Life_Extended)

- [10 Detect Life Form, Detect Life Form Extended](#Detect_Life_Form.2C_Detect_Life_Form_Extended)

- [11 Detect Magic, Detect Magic Extended](#Detect_Magic.2C_Detect_Magic_Extended)

- [12 Detect Object](#Detect_Object)

- [13 Mindlink](#Mindlink)

- [14 Mind Probe](#Mind_Probe)

- [15 Astral Message](#Astral_Message)

- [16 Astral Clairvoyance](#Astral_Clairvoyance)

- [17 Borrow Sense, Animal Sense, Eyes of the Pack](#Borrow_Sense.2C_Animal_Sense.2C_Eyes_of_the_Pack)

- [18 Catalog](#Catalog)

- [19 Diagnose](#Diagnose)

- [20 Dragon Astral Signature](#Dragon_Astral_Signature)

- [21 Enhance Aim](#Enhance_Aim)

- [22 Hawkeye](#Hawkeye)

- [23 Mana Window, Astral Window](#Mana_Window.2C_Astral_Window)

- [24 Mindnet, Mindnet Extended](#Mindnet.2C_Mindnet_Extended)

- [25 Night Vision](#Night_Vision)

- [26 Sense Cryptesthesia](#Sense_Cryptesthesia)

- [27 Spatial Sense, Spatial Sense Extended](#Spatial_Sense.2C_Spatial_Sense_Extended)

- [28 Thought Recognition, Area Thought Recognition](#Thought_Recognition.2C_Area_Thought_Recognition)
