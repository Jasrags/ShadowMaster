...
- Raw spell entries reside in `shadowrun-5e-magic-data.md` (to be populated).
...
- Model spells, rituals, adept powers, foci, spirits, and mentor spirits via structured data in `shadowrun-5e-magic-data.md`.
