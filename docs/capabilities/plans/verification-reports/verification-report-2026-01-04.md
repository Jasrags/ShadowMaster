...
|----------|-------|-------------|
| 1 | 38 | Missing items |
| 2 | 15 | Data mismatches |
| 3 | 0 | Duplicates |
| 4 | 355 | Invalid source |
| 5 | 0 | Naming issues |
...
- **Beretta 201T**
  ...
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update beretta-201t.rc from 1 to – (1)

- **Fichetti Security 600**
  - Field "rc" mismatch
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update fichetti-security-600.rc from 1 to – (1)
...
- **Remington Roomsweeper**
  ...
  - Expected: `7`
  - Actual: `"9P(f)"`
  - Recommendation: Update remington-roomsweeper.damage from 9P(f) to 7
...
- **SCK Model 100**
  ...
  - Expected: `"– (1)"`
  - Actual: `0`
  - Recommendation: Update scm-70.rc from 0 to – (1)

- **Uzi IV**
  - Field "rc" mismatch
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update uzi-iv.rc from 1 to – (1)
...
- **Yamaha Raiden**
  ...
  - Expected: `2`
  - Actual: `6`
  - Recommendation: Update yamaha-raiden.rc from 6 to 2
...
- **Cavalier Arms Crockett EBR**
  ...
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update cavalier-arms-crockett-ebr.rc from 1 to – (1)
...
- **Ruger 100**
  ...
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update ruger-100.rc from 1 to – (1)
...
- **PJSS Model 55**
  ...
  - Expected: `"– (1)"`
  - Actual: `1`
  - Recommendation: Update pjss-model-55.rc from 1 to – (1)
...
- **Mossberg AM-CMDT**
  - Item "mossberg-am-cmdt" not found in reference files for sources: Core
  - Recommendation: Verify source of "mossberg-am-cmdt" - may need removal or move to sourcebook
...
- **Control Rig (Rating 1)**
  - Item "control-rig-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "control-rig-1" - may need removal or move to sourcebook

- **Control Rig (Rating 2)**
  - Item "control-rig-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "control-rig-2" - may need removal or move to sourcebook

- **Control Rig (Rating 3)**
  - Item "control-rig-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "control-rig-3" - may need removal or move to sourcebook
...
- **Cybereyes (Rating 1)**
  - Item "cybereyes-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "cybereyes-1" - may need removal or move to sourcebook

- **Cybereyes (Rating 2)**
  - Item "cybereyes-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "cybereyes-2" - may need removal or move to sourcebook

- **Cybereyes (Rating 3)**
  - Item "cybereyes-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "cybereyes-3" - may need removal or move to sourcebook

- **Cybereyes (Rating 4)**
  - Item "cybereyes-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "cybereyes-4" - may need removal or move to sourcebook
...
- **Cyberears (Rating 1)**
  - Item "cyberears-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "cyberears-1" - may need removal or move to sourcebook

- **Cyberears (Rating 2)**
  - Item "cyberears-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "cyberears-2" - may need removal or move to sourcebook

- **Cyberears (Rating 3)**
  - Item "cyberears-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "cyberears-3" - may need removal or move to sourcebook

- **Cyberears (Rating 4)**
  - Item "cyberears-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "cyberears-4" - may need removal or move to sourcebook
...
- **Dermal Plating (Rating 1)**
  - Item "dermal-plating-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-1" - may need removal or move to sourcebook

- **Dermal Plating (Rating 2)**
  - Item "dermal-plating-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-2" - may need removal or move to sourcebook

- **Dermal Plating (Rating 3)**
  - Item "dermal-plating-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-3" - may need removal or move to sourcebook

- **Dermal Plating (Rating 4)**
  - Item "dermal-plating-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-4" - may need removal or move to sourcebook

- **Dermal Plating (Rating 5)**
  - Item "dermal-plating-5" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-5" - may need removal or move to sourcebook

- **Dermal Plating (Rating 6)**
  - Item "dermal-plating-6" not found in reference files for sources: Core
  - Recommendation: Verify source of "dermal-plating-6" - may need removal or move to sourcebook
...
- **Internal Air Tank (Rating 1)**
  - Item "internal-air-tank-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "internal-air-tank-1" - may need removal or move to sourcebook

- **Internal Air Tank (Rating 2)**
  - Item "internal-air-tank-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "internal-air-tank-2" - may need removal or move to sourcebook

- **Internal Air Tank (Rating 3)**
  - Item "internal-air-tank-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "internal-air-tank-3" - may need removal or move to sourcebook

- **Muscle Replacement (Rating 1)**
  - Item "muscle-replacement-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-replacement-1" - may need removal or move to sourcebook

- **Muscle Replacement (Rating 2)**
  - Item "muscle-replacement-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-replacement-2" - may need removal or move to sourcebook

- **Muscle Replacement (Rating 3)**
  - Item "muscle-replacement-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-replacement-3" - may need removal or move to sourcebook

- **Muscle Replacement (Rating 4)**
  - Item "muscle-replacement-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-replacement-4" - may need removal or move to sourcebook

- **Orthoskin (Rating 1)**
  - Item "orthoskin-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-1" - may need removal or move to sourcebook

- **Orthoskin (Rating 2)**
  - Item "orthoskin-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-2" - may need removal or move to sourcebook

- **Orthoskin (Rating 3)**
  - Item "orthoskin-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-3" - may need removal or move to sourcebook

- **Orthoskin (Rating 4)**
  - Item "orthoskin-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-4" - may need removal or move to sourcebook
...
- **Reaction Enhancers (Rating 1)**
  - Item "reaction-enhancers-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "reaction-enhancers-1" - may need removal or move to sourcebook

- **Reaction Enhancers (Rating 2)**
  - Item "reaction-enhancers-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "reaction-enhancers-2" - may need removal or move to sourcebook

- **Reaction Enhancers (Rating 3)**
  - Item "reaction-enhancers-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "reaction-enhancers-3" - may need removal or move to sourcebook
...
- **Synthacardium (Rating 1)**
  - Item "synthacardium-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-1" - may need removal or move to sourcebook

- **Synthacardium (Rating 2)**
  - Item "synthacardium-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-2" - may need removal or move to sourcebook

- **Synthacardium (Rating 3)**
  - Item "synthacardium-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-3" - may need removal or move to sourcebook

- **Wired Reflexes (Rating 1)**
  - Item "wired-reflexes-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "wired-reflexes-1" - may need removal or move to sourcebook

- **Wired Reflexes (Rating 2)**
  - Item "wired-reflexes-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "wired-reflexes-2" - may need removal or move to sourcebook

- **Wired Reflexes (Rating 3)**
  - Item "wired-reflexes-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "wired-reflexes-3" - may need removal or move to sourcebook
...
- **Adrenaline Pump (Rating 1)**
  - Item "adrenaline-pump-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "adrenaline-pump-1" - may need removal or move to sourcebook

- **Adrenaline Pump (Rating 2)**
  - Item "adrenaline-pump-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "adrenaline-pump-2" - may need removal or move to sourcebook

- **Adrenaline Pump (Rating 3)**
  - Item "adrenaline-pump-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "adrenaline-pump-3" - may need removal or move to sourcebook
...
- **Muscle Augmentation (Rating 1)**
  - Item "muscle-augmentation-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-augmentation-1" - may need removal or move to sourcebook

- **Muscle Augmentation (Rating 2)**
  - Item "muscle-augmentation-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-augmentation-2" - may need removal or move to sourcebook

- **Muscle Augmentation (Rating 3)**
  - Item "muscle-augmentation-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-augmentation-3" - may need removal or move to sourcebook

- **Muscle Augmentation (Rating 4)**
  - Item "muscle-augmentation-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-augmentation-4" - may need removal or move to sourcebook

- **Muscle Toner (Rating 1)**
  - Item "muscle-toner-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-toner-1" - may need removal or move to sourcebook

- **Muscle Toner (Rating 2)**
  - Item "muscle-toner-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-toner-2" - may need removal or move to sourcebook

- **Muscle Toner (Rating 3)**
  - Item "muscle-toner-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-toner-3" - may need removal or move to sourcebook

- **Muscle Toner (Rating 4)**
  - Item "muscle-toner-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "muscle-toner-4" - may need removal or move to sourcebook

- **Orthoskin (Bioware, Rating 1)**
  - Item "orthoskin-bio-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-bio-1" - may need removal or move to sourcebook

- **Orthoskin (Bioware, Rating 2)**
  - Item "orthoskin-bio-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-bio-2" - may need removal or move to sourcebook

- **Orthoskin (Bioware, Rating 3)**
  - Item "orthoskin-bio-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-bio-3" - may need removal or move to sourcebook

- **Orthoskin (Bioware, Rating 4)**
  - Item "orthoskin-bio-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "orthoskin-bio-4" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 1)**
  - Item "pathogenic-defense-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-1" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 2)**
  - Item "pathogenic-defense-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-2" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 3)**
  - Item "pathogenic-defense-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-3" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 4)**
  - Item "pathogenic-defense-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-4" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 5)**
  - Item "pathogenic-defense-5" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-5" - may need removal or move to sourcebook

- **Pathogenic Defense (Rating 6)**
  - Item "pathogenic-defense-6" not found in reference files for sources: Core
  - Recommendation: Verify source of "pathogenic-defense-6" - may need removal or move to sourcebook

- **Platelet Factories (Bioware)**
  - Item "platelet-factories-bio" not found in reference files for sources: Core
  - Recommendation: Verify source of "platelet-factories-bio" - may need removal or move to sourcebook
...
- **Suprathyroid Gland**
  - Item "suprathyroid-gland-bio" not found in reference files for sources: Core
  - Recommendation: Verify source of "suprathyroid-gland-bio" - may need removal or move to sourcebook

- **Symbiotes (Rating 1)**
  - Item "symbiotes-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "symbiotes-1" - may need removal or move to sourcebook

- **Symbiotes (Rating 2)**
  - Item "symbiotes-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "symbiotes-2" - may need removal or move to sourcebook

- **Symbiotes (Rating 3)**
  - Item "symbiotes-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "symbiotes-3" - may need removal or move to sourcebook

- **Symbiotes (Rating 4)**
  - Item "symbiotes-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "symbiotes-4" - may need removal or move to sourcebook

- **Synthacardium (Bioware, Rating 1)**
  - Item "synthacardium-bio-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-bio-1" - may need removal or move to sourcebook

- **Synthacardium (Bioware, Rating 2)**
  - Item "synthacardium-bio-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-bio-2" - may need removal or move to sourcebook

- **Synthacardium (Bioware, Rating 3)**
  - Item "synthacardium-bio-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "synthacardium-bio-3" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 1)**
  - Item "tracheal-filter-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-1" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 2)**
  - Item "tracheal-filter-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-2" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 3)**
  - Item "tracheal-filter-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-3" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 4)**
  - Item "tracheal-filter-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-4" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 5)**
  - Item "tracheal-filter-5" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-5" - may need removal or move to sourcebook

- **Tracheal Filter (Rating 6)**
  - Item "tracheal-filter-6" not found in reference files for sources: Core
  - Recommendation: Verify source of "tracheal-filter-6" - may need removal or move to sourcebook

- **Tailored Pheromones (Rating 1)**
  - Item "tailored-pheromones-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "tailored-pheromones-1" - may need removal or move to sourcebook

- **Tailored Pheromones (Rating 2)**
  - Item "tailored-pheromones-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "tailored-pheromones-2" - may need removal or move to sourcebook

- **Tailored Pheromones (Rating 3)**
  - Item "tailored-pheromones-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "tailored-pheromones-3" - may need removal or move to sourcebook

- **Bone Density Augmentation (Rating 1)**
  - Item "bone-density-augmentation-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "bone-density-augmentation-1" - may need removal or move to sourcebook

- **Bone Density Augmentation (Rating 2)**
  - Item "bone-density-augmentation-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "bone-density-augmentation-2" - may need removal or move to sourcebook

- **Bone Density Augmentation (Rating 3)**
  - Item "bone-density-augmentation-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "bone-density-augmentation-3" - may need removal or move to sourcebook

- **Bone Density Augmentation (Rating 4)**
  - Item "bone-density-augmentation-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "bone-density-augmentation-4" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 1)**
  - Item "toxin-extractor-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-1" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 2)**
  - Item "toxin-extractor-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-2" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 3)**
  - Item "toxin-extractor-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-3" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 4)**
  - Item "toxin-extractor-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-4" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 5)**
  - Item "toxin-extractor-5" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-5" - may need removal or move to sourcebook

- **Toxin Extractor (Rating 6)**
  - Item "toxin-extractor-6" not found in reference files for sources: Core
  - Recommendation: Verify source of "toxin-extractor-6" - may need removal or move to sourcebook

- **Cerebral Booster (Rating 1)**
  - Item "cerebral-booster-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "cerebral-booster-1" - may need removal or move to sourcebook

- **Cerebral Booster (Rating 2)**
  - Item "cerebral-booster-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "cerebral-booster-2" - may need removal or move to sourcebook

- **Cerebral Booster (Rating 3)**
  - Item "cerebral-booster-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "cerebral-booster-3" - may need removal or move to sourcebook

- **Damage Compensators (Rating 1)**
  - Item "damage-compensators-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-1" - may need removal or move to sourcebook

- **Damage Compensators (Rating 2)**
  - Item "damage-compensators-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-2" - may need removal or move to sourcebook

- **Damage Compensators (Rating 3)**
  - Item "damage-compensators-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-3" - may need removal or move to sourcebook

- **Damage Compensators (Rating 4)**
  - Item "damage-compensators-4" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-4" - may need removal or move to sourcebook

- **Damage Compensators (Rating 5)**
  - Item "damage-compensators-5" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-5" - may need removal or move to sourcebook

- **Damage Compensators (Rating 6)**
  - Item "damage-compensators-6" not found in reference files for sources: Core
  - Recommendation: Verify source of "damage-compensators-6" - may need removal or move to sourcebook

- **Mnemonic Enhancer (Rating 1)**
  - Item "mnemonic-enhancer-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "mnemonic-enhancer-1" - may need removal or move to sourcebook

- **Mnemonic Enhancer (Rating 2)**
  - Item "mnemonic-enhancer-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "mnemonic-enhancer-2" - may need removal or move to sourcebook

- **Mnemonic Enhancer (Rating 3)**
  - Item "mnemonic-enhancer-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "mnemonic-enhancer-3" - may need removal or move to sourcebook
...
- **Synaptic Booster (Rating 1)**
  - Item "synaptic-booster-1" not found in reference files for sources: Core
  - Recommendation: Verify source of "synaptic-booster-1" - may need removal or move to sourcebook

- **Synaptic Booster (Rating 2)**
  - Item "synaptic-booster-2" not found in reference files for sources: Core
  - Recommendation: Verify source of "synaptic-booster-2" - may need removal or move to sourcebook

- **Synaptic Booster (Rating 3)**
  - Item "synaptic-booster-3" not found in reference files for sources: Core
  - Recommendation: Verify source of "synaptic-booster-3" - may need removal or move to sourcebook
...
- **Full Helmet**
  - Item "full-helmet" not found in reference files for sources: Core
  - Recommendation: Verify source of "full-helmet" - may need removal or move to sourcebook
...
- **SecureTech PPE**
  - Item "securetech-ppe" not found in reference files for sources: Core
  - Recommendation: Verify source of "securetech-ppe" - may need removal or move to sourcebook
