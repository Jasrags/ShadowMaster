...
export function updateGruntTeamState(
  teamId: ID,
...
export function getGruntTemplate(
  editionCode: string,
  templateId: ID
): GruntTemplate | null;
```
...
export function rollSpecialistInitiative(specialist: GruntSpecialist, baseStats: GruntStats): number;
