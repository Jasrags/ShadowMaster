...
export function SkillSourceFilter({ skills, selectedSources, onSourcesChange }: SkillSourceFilterProps) {
  ...
  // Get all unique sources with counts (filter out skills without sources)
