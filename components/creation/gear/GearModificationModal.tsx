...
import { X, Search, AlertTriangle, Backpack, Minus, Plus } from "lucide-react";
...
export function GearModificationModal({
  ...
  const [selectedMod, setSelectedMod] =
    useState<GearModificationCatalogItemData | null>(null);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative mx-4 flex max-h-[85vh] w-full max-w-3xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-zinc-900">
        {/* Header */}
                  ...
                  <div className="flex justify-between rounded bg-zinc-50 px-3 py-2 text-sm dark:bg-zinc-800">
                    ...
                    >
                      {getAvailabilityDisplay(
                        selectedMod.availability,
                        selectedMod.legality
                      )}
                    </span>
                  </div>
                </div>
