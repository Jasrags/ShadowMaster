...
export function CyberlimbWeaponModal({
  ...
  const availableWeapons = useMemo(() => {
    ...
    return cyberwareCatalog.catalog.filter((item) => {
      ...
      if ((item.availability ?? 0) > maxAvailability && item.legality !== "restricted")
        return false;
  ...
  const canAddToCart =
    ...
    canAfford &&
    fitsCapacity &&
    (meetsAvailability || selectedItem.legality === "restricted");
                  ...
                  <div className="flex-1 overflow-y-auto p-4">
                    ...
                    {selectedItem.legality === "forbidden" && (
                      <div className="mt-3 rounded-lg bg-red-50 p-2 text-xs text-red-700 dark:bg-red-900/20 dark:text-red-300">
                        <strong>Forbidden:</strong> This weapon is illegal and may not be available
