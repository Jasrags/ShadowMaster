...
export function VehicleModal({ isOpen, onClose, onAdd, remainingNuyen }: VehicleModalProps) {
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-xs text-zinc-500 dark:text-zinc-400">
                          ...
                          <span>
                            B/A: {vehicle.body}/{vehicle.armor}
                          </span>
                          <span>
                            P/S: {vehicle.pilot}/{vehicle.sensor}
                          </span>
                          <span>
                            Avail: {getAvailabilityDisplay(vehicle.availability, vehicle.legality)}
                          </span>
                        </div>
                      </div>
