...
export function CyberlimbAccessoryModal({
  ...
  return (
    ...
    >
      <Modal className="flex h-[80vh] w-full max-w-3xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
        <Dialog className="flex h-[80vh] flex-col outline-none">
          {({ close }) => (
            <>
              {/* Header */}
                  ...
                  <div className="border-b border-zinc-200 p-4 dark:border-zinc-800">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-zinc-300 bg-white py-2 pl-9 pr-3 text-sm text-zinc-900 placeholder-zinc-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder-zinc-500"
                      />
                    </div>
                  </div>
                          ...
                          return (
                            <button
                              ...
                              className={`flex w-full items-start justify-between rounded-lg p-3 text-left transition-colors ${
                                isSelected
                                  ? "border border-blue-500 bg-blue-50 dark:bg-blue-500/10"
                                  : !fits
                                    ? "cursor-not-allowed bg-zinc-50 opacity-50 dark:bg-zinc-800/30"
                  ...
                  {selectedItem && calculations ? (
                    <>
                      ...
                      <div className="flex-1 overflow-y-auto p-4">
                        ...
                        {selectedItem.hasRating && (
                          <div className="mb-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="w-14 h-12 flex items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-800">
                              ...
                              <button
                                ...
                                className={`p-2 rounded-lg ${
                                  rating < (selectedItem.maxRating || 6)
                                    ? "bg-blue-50 text-blue-500 hover:bg-blue-100 dark:bg-blue-500/20 dark:text-blue-400 dark:hover:bg-blue-500/30"
                                    : "bg-zinc-100 text-zinc-400 cursor-not-allowed dark:bg-zinc-800 dark:text-zinc-600"
                                }`}
                              >
                        ...
                        {/* Capacity preview */}
                        <div className="flex items-center gap-2 rounded-lg bg-blue-50 px-3 py-2 mb-4 dark:bg-blue-500/10">
