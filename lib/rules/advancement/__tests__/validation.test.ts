...
describe("Advancement Validation", () => {
  ...
  describe("validateAttributeAdvancement", () => {
    it("should validate successful attribute advancement", () => {
      const result = validateAttributeAdvancement(character, "body", 4, ruleset);
      expect(result.valid).toBe(true);
    ...
    it("should reject rating not higher than current", () => {
      const result = validateAttributeAdvancement(character, "body", 3, ruleset);
      expect(result.valid).toBe(false);
    ...
    it("should reject rating exceeding metatype maximum", () => {
      const result = validateAttributeAdvancement(character, "body", 7, ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
    ...
    it("should reject insufficient karma", () => {
      ...
      const result = validateAttributeAdvancement(poorCharacter, "body", 4, ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
    ...
    it("should calculate correct cost", () => {
      const result = validateAttributeAdvancement(character, "body", 5, ruleset);
  ...
  describe("validateSkillAdvancement", () => {
    it("should validate successful skill advancement", () => {
      const result = validateSkillAdvancement(character, "firearms", 4, ruleset);
      expect(result.valid).toBe(true);
      expect(result.errors).toHaveLength(0);
    ...
    it("should reject rating not higher than current", () => {
      const result = validateSkillAdvancement(character, "firearms", 3, ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
          message: expect.stringContaining("must be higher than current"),
    ...
    it("should reject rating exceeding maximum", () => {
      ...
      const result = validateSkillAdvancement(highSkillCharacter, "firearms", 13, ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
          message: expect.stringContaining("exceeds maximum"),
    ...
    it("should reject insufficient karma", () => {
      ...
      const result = validateSkillAdvancement(poorCharacter, "firearms", 4, ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
          message: expect.stringContaining("Not enough karma"),
    ...
    it("should calculate correct cost", () => {
      const result = validateSkillAdvancement(character, "firearms", 5, ruleset);
  ...
  describe("validateSpecializationAdvancement", () => {
    it("should validate successful specialization learning", () => {
      ...
      const result = validateSpecializationAdvancement(highSkillCharacter, "firearms", ruleset);
      expect(result.valid).toBe(true);
      expect(result.errors).toHaveLength(0);
    ...
    it("should reject if skill rating is below 4", () => {
      const result = validateSpecializationAdvancement(character, "firearms", ruleset);
      expect(result.valid).toBe(false);
      expect(result.errors).toContainEqual(
        expect.objectContaining({
