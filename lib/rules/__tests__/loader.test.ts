        ...
        payload: {
          ...
          modules: {
            ...
            lifestyle: {
              payload: {
                lifestyles: [
                  { id: 'street', name: 'Street', monthlyCost: 0, startingNuyen: '0' },
                ],
            ...
            contactTemplates: {
              payload: {
                templates: [
                  { id: 'fixer', name: 'Fixer', connection: 3, loyalty: 2 },
                ],
              },
            },
            adeptPowers: {
              payload: {
                powers: [
                  { id: 'improved-reflexes', name: 'Improved Reflexes', cost: 1.5, costType: 'perLevel' },
                ],
              },
            },
          },
