...
Before starting implementation, create a feature branch for M0.3.9 work:

```bash
git checkout -b feature/m0.3.9-free-skills
```

This keeps the work isolated and makes it easier to review and merge when complete.
